...
public class Cms {
	...
	public Cms(boolean bPrintLog) {
		...
		try {
			...
			plainText = Disk.read("./Sample/CMS/plainText.txt");
		} catch (Exception e) {
			e.printStackTrace();
			nErrCnt++;		
		}
	...
	public void signData() {
		...
		try {
			...
			signerCert1 = Disk.readCert("./Sample/CMS/signCert1.der");
			signerPriKey1 = Disk.readPriKey("./Sample/CMS/signPri1.key", "1111");
			
			signerCert2 = Disk.readCert("./Sample/CMS/signCert2.der");
			signerPriKey2 = Disk.readPriKey("./Sample/CMS/signPri2.key", "qwer1234");
			...
			signedData.setMessage_File("./Sample/CMS/plainText_File.txt");
			signedData.generate_File(signerCert1, signerPriKey1, "./Sample/CMS/SignedData_File.ber");
			System.out.println("  ... ok");
			...
			outData = Disk.read("./Sample/CMS/SignedData.ber");
			...
			signedData.verify_File("./Sample/CMS/SignedData_File.ber", "./Sample/CMS/message_File.txt");
	...
	void envData() {
		...
		try {
			...
			recCert1 = Disk.readCert("./Sample/CMS/kmCert1.der");
			recPriKey1 = Disk.readPriKey("./Sample/CMS/kmPri1.key", "1111");
			
			recCert2 = Disk.readCert("./Sample/CMS/kmCert2.der");
			recPriKey2 = Disk.readPriKey("./Sample/CMS/kmPri2.key", "qwer1234");
			...
			envData.generate_File("./Sample/CMS/plainText_File.txt", "./Sample/CMS/envData_File.ber");
			...
			outData = Disk.read("./Sample/CMS/EnvelopedData.ber");
			...
			msg = envData.process_File("./Sample/CMS/EnvData_File.ber", recCert1, recPriKey1, "./Sample/CMS/Messsage_File.txt");
	...
	void signedAndEnvData() {
		...
		try {
			...
			signerCert = Disk.readCert("./Sample/CMS/signCert1.der");
			signerKey = Disk.readPriKey("./Sample/CMS/signPri1.key", "1111");
			
			kmCert = Disk.readCert("./Sample/CMS/kmCert1.der");
			kmKey = Disk.readPriKey("./Sample/CMS/kmPri1.key", "1111");
	...
	void signedContent() {
		...
		try {
			...
			signerCert = Disk.readCert("./Sample/CMS/signCert3.der");
			signerPriKey = Disk.readPriKey("./Sample/CMS/signPri3.key", "88888888");
			...
			System.out.print("  - Compatibility");
			outData = Disk.read("./Sample/CMS/SignedContent.xdr");
	...
	void wapEnvData() {
		...
		try {
			...
			recCert = Disk.readCert("./Sample/CMS/kmCert1.der");
			recPriKey = Disk.readPriKey("./Sample/CMS/kmPri1.key", "1111");
			...
			System.out.print("  - Compatibility");
			outData = Disk.read("./Sample/CMS/WapEnvelopedData.xdr");
