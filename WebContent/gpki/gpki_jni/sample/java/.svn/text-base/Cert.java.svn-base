...
public class Cert {
	...
	void view() {
		...
		try {
			...
			X509Certificate x509Cert = Disk.readCert("./Sample/CERT/viewCert.der");
	...
	void verify() {
		...
		try {
			certPathValiditor = new CertPathValidator("./gpkiapi.conf");
			
			X509Certificate rootCert = Disk.readCert("./Sample/CERT/KISA.der");
			...
			cert = Disk.readCert("./Sample/CERT/gpkiCert.cer");
		...
		try {
			...
			cert = Disk.readCert("./Sample/CERT/yessignCert.der");
			certPathValiditor.setRevokationCheck(CertPathValidator.REVOKE_CHECK_ARL | CertPathValidator.REVOKE_CHECK_CRL);
			certPathValiditor.validate(CertPathValidator.CERT_SIGN, cert);
			System.out.println("  OK...");
		...
		try {
			...
			cert = Disk.readCert("./Sample/CERT/tradesignCert.der");
		...
		try {
			...
			cert = Disk.readCert("./Sample/CERT/signkoreaCert.der");
			certPathValiditor.setRevokationCheck(CertPathValidator.REVOKE_CHECK_ARL | CertPathValidator.REVOKE_CHECK_CRL | CertPathValidator.REVOKE_CHECK_OCSP);
			certPathValiditor.validate(CertPathValidator.CERT_SIGN, cert);
			System.out.println("  OK...");
		...
		try {
			...
			cert = Disk.readCert("./Sample/CERT/kicaCert.der");
			certPathValiditor.setRevokationCheck(CertPathValidator.REVOKE_CHECK_ARL | CertPathValidator.REVOKE_CHECK_CRL | CertPathValidator.REVOKE_CHECK_OCSP);
			certPathValiditor.validate(CertPathValidator.CERT_SIGN, cert);
			System.out.println("  OK...");
		...
		try {
			...
			cert = Disk.readCert("./Sample/CERT/crossCert.der");
			certPathValiditor.setRevokationCheck(CertPathValidator.REVOKE_CHECK_ARL | CertPathValidator.REVOKE_CHECK_CRL | CertPathValidator.REVOKE_CHECK_OCSP);
		...
		try {
			...
			cert = Disk.readCert("./Sample/CERT/ncasignCert.der");
			certPathValiditor.setRevokationCheck(CertPathValidator.REVOKE_CHECK_ARL | CertPathValidator.REVOKE_CHECK_CRL | CertPathValidator.REVOKE_CHECK_OCSP);
			certPathValiditor.validate(CertPathValidator.CERT_SIGN, cert);
			System.out.println("  OK...");
	...
	void verifyVID() {
		...
		try {
			...
			X509Certificate cert = Disk.readCert("./Sample/CERT/vidCert.der");
			PrivateKey prikey = Disk.readPriKey("./Sample/CERT/vidPri.key", "88888888");
	...
	void checkStatus() {
		...
		try {
			...
			X509Certificate cert = Disk.readCert("./Sample/CERT/vidCert.der");
			X509Certificate myCert = Disk.readCert("./Sample/CERT/vidCert.der");
			PrivateKey myPriKey = Disk.readPriKey("./Sample/CERT/vidPri.key", "88888888");
			...
			Disk.write("./Sample/CERT/ocspReqMsg.ber", reqMsg);
			
			byte[] resMsg;
			resMsg = Disk.read("./Sample/CERT/ocspResMsg.ber");
