        ...
        <tr>
          <td align="center" valign="top" bgcolor="#F7F7F7">
		    <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border:1px solid #DFDFDF">
				...
				<!-- 전자서명 -->
			  <tr>
				<form name='SignPhp' action='EncSignData_S.php' method="post">
							...
							<td align="center" valign="middle">
								<table width="461" height="129" border="0" cellpadding="0" cellspacing="0" background="img/login_bg_m.gif">
									<tr align="right" valign="top">
										<td width="500">전자서명 <br> + 세션키암호<br>화할 데이터&nbsp;</td>
										<td align="left" valign="top">
										<input type="text" name="signData" size ="30" >
										<input type="button" name="btn" value="encSign(php)" onClick="EncryptedSignData(SignPhp)">
										</td>
									</tr>
								</table>
							</td>
