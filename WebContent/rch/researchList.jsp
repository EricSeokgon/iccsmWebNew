...
<!-- 진행중 설문조사   START -->
<table width="100%" border="0"  cellspacing="0" cellpadding="3" id="tab1" style="display:">
  <tr >
...
%>
	<tr >
		...
		<td align="center" class="listTable_td">진행중</td>
	</tr>
<%}
	if( rEntity.getRowCnt() == 0) {
%>
	<tr>
		<td class="listTable_td" colspan="9" align="center">진행중인  설문조사가 없습니다.</td>
	</tr>
<%}%>
</table>
<!-- 진행중 설문조사  END -->
