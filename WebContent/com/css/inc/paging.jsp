...
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
	<tr>
		<td width="11" height="11"><img src="../images/box02_1.gif"></td>
		<td background="../images/box02_2.gif"></td>
		<td width="11"><img src="../images/box02_3.gif"></td>
	</tr>
	<tr>
		<td background="../images/box02_8.gif"></td>
...
<table  width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    ...
    <td class="paging" width="200" align="left">페이지 [<%=n_page%>/<%=totalPage%>] <br> 전  체 : <%=total_cnt%>건</td>
    ...
    <td  width="200" align="right"> <KTags:KJFSelect item="<%=KJFUtil.getSelPageLine()%>"
		...
		<td background="../images/box02_4.gif"></td>
	</tr>
	<tr>
		<td width="11" height="11"><img src="../images/box02_7.gif"></td>
		<td background="../images/box02_6.gif"></td>
		<td width="11"><img src="../images/box02_5.gif"></td>
	</tr>
</table>
<!------box end--------->
<table width="100%" border="0" cellpadding="0" cellspacing="0">
