...
//	System.out.println("---> sido_code" + sido_code + " sigg_code" + sigg_code + "area_url "+ area_url );	
...
//			len = is.read(in, offset, in.length);
	...
	//	System.out.println("try===>2222");
		PlatformData pdata = new PlatformData (out_vl, out_dl);
		platformResponse.sendData(out_vl, out_dl);
	//	System.out.println("try===>3333");
	}catch(Exception e)
	{
	//	System.out.println("exception===>0000");
	//	System.out.println(e.toString());
	}
