...
public class RepnameChgListMgrCmd implements KJFCommand {
	
    private String next;	
    private DatasetList  dl = new DatasetList();
    private VariableList vl = new VariableList();
    
    public RepnameChgListMgrCmd () {
    }

    public  RepnameChgListMgrCmd (String next_url) {
    	next = next_url;
    }
...
//        sQuery.append(" FROM PT_R_COMPANY_MASTER PT_M ");
        /*
        sQuery.append(" SELECT PT_H.COI_WRT_NUM, PT_H.CHG_DT, PT_H.REP_NM_KOR, PT_H.CHGBRE_SEQ, PT_R.NAME, PT_H.TMP_WRT_NUM,PT_C.CODE_NAME, PT_H.WRT_DT ");
       ...
       */
       // sWhere.append(" AND PT_H.TMP_WRT_NUM = '" + scTMP_WRT_NUM + "'");
        sQuery.append(" select a.COI_WRT_NUM, b.name, a.WRT_CHG_DT, a.CHG_STA_DT, FNGetPrevRep(a.COI_WRT_NUM, a.WRT_CHG_DT ) prev_REP_NM_KOR, a.REP_NM_KOR");
        sQuery.append(" from PT_TMP_REP_CHANGE a,  PT_R_company_master b");
        sQuery.append(" WHERE 1 = 1 ");
        sQuery.append(" and a.seq in(");
        sQuery.append(" select max(seq) seq from PT_TMP_REP_CHANGE");
        ...
        /*
        sWhere.append(" AND PT_C.CODE='R00009' ");
