...
public class UserMgrBasicCCmd implements KJFCommand {
	
    private String next;	
    private static DatasetList  dl = new DatasetList();
    private VariableList vl = new VariableList();
    
    public UserMgrBasicCCmd() {
    }

    public UserMgrBasicCCmd(String next_url) {
    	next = next_url;
    }
    ...
    private void Search(String OFFI_ID, String scNM, String scSIDO)throws Exception{
        ...
        sQuery.append(" SELECT '0' AS CHECKER, A.OFFI_ID, A.NM, A.TEL ,A.SIDO_CODE, A.SIGUNGU_CODE, A.E_MAIL, A.MOBILE,A.FAX, \n");
        sQuery.append(" A.PART, A.POS, A.GROUP_CODE, A.PASS AS PASS, A.PASS AS PASS2, A.HOME_GROUP, A.PHOTO,\n");
        sQuery.append(" A.TEL1,A.TEL2,A.TEL3,A.MOBILE1,A.MOBILE2,A.MOBILE3,A.FAX1,A.FAX2,A.FAX3,  \n");
        sQuery.append(" B.SIDO_NM AS SIDO_NM, C.SIGUNGU_NM AS SIGUNGU_NM    \n");
        sQuery.append(" FROM PT_MI_USER_BASIC A LEFT JOIN PT_SIDO_CODE B ON A.SIDO_CODE = B.AREA_CODE   \n");
