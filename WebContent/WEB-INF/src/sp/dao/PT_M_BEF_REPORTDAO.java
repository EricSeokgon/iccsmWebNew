...
public class PT_M_BEF_REPORTDAO  extends SuperToDB{

  private String default_fields[]={ "SEQ" , "NOTE_CLASS_CODE" , "SEND_DT" , "S_PER" , "PROC_LIM" , "RECV_YN" , "REMARK" , "INS_DT" , "UPD_DT" , "WRT_ID" , "TMP_WRT_NUM" , "WRT_NUM" , "RECV_LOC" , "NOTE_METHOD_CLASS" , "GUBUN" };	

  public int insert( ValueObject  obj) throws SQLException{

    if((obj instanceof PT_M_BEF_REPORTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_M_BEF_REPORT : insert() ");
    }
    PT_M_BEF_REPORTEntity entity = (PT_M_BEF_REPORTEntity)obj;
  ...
  sb.append("insert into PT_M_BEF_REPORT ")
    .append(" ( SEQ,NOTE_CLASS_CODE,SEND_DT,S_PER,PROC_LIM,RECV_YN,REMARK,INS_DT,UPD_DT,WRT_ID,TMP_WRT_NUM,WRT_NUM,RECV_LOC,NOTE_METHOD_CLASS,GUBUN ) ")
    .append(" values ( ")
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_M_BEF_REPORTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_M_BEF_REPORT : update() ");
    }
    PT_M_BEF_REPORTEntity entity = (PT_M_BEF_REPORTEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_M_BEF_REPORT  set ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_M_BEF_REPORTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_M_BEF_REPORT : updateModifiedOnly() ");
    }
    PT_M_BEF_REPORTEntity entity = (PT_M_BEF_REPORTEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_M_BEF_REPORTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_M_BEF_REPORT : delete() ");
    }
    PT_M_BEF_REPORTEntity entity = (PT_M_BEF_REPORTEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_M_BEF_REPORT  where  1=1")
