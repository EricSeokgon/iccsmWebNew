...
public class PT_C_RES_SWITEntity extends ValueObject{
     ...
     private String OUTLINE_CH_NUM;
  
     private String OUTLINE_E1_NUM;
...
//생성자를 만든다
    public PT_C_RES_SWITEntity(){
    }
    
    
    public PT_C_RES_SWITEntity(String SEQ ){
       this.setSEQ(SEQ);
       
    }
      
    public PT_C_RES_SWITEntity(ValueObject ent) throws Exception{
       Object value = null; 
    ...
    public void setRequestOnlyString(HttpServletRequest request) throws Exception{
		...
		this.INLINE_NUM =request.getParameter("INLINE_NUM");
		this.OUTLINE_CH_NUM =request.getParameter("OUTLINE_CH_NUM");
		this.OUTLINE_E1_NUM =request.getParameter("OUTLINE_E1_NUM");
    ...
    public void setDsOnlyString(Dataset ds, int arg_row) throws Exception{  
		...
		this.INLINE_NUM =KJFMi.dsGet(ds, arg_row, "INLINE_NUM");
		this.OUTLINE_CH_NUM =KJFMi.dsGet(ds, arg_row, "OUTLINE_CH_NUM");
		this.OUTLINE_E1_NUM =KJFMi.dsGet(ds, arg_row, "OUTLINE_E1_NUM");
...
//Getter 함수를 만든다
     ...
     public String getOUTLINE_CH_NUM(){
             return OUTLINE_CH_NUM;
     };
  
     public String getOUTLINE_E1_NUM(){
             return OUTLINE_E1_NUM;
     };
...
//Setter 함수를 만든다
     ...
     public void setINLINE_NUM(String INLINE_NUM){
            this.INLINE_NUM=INLINE_NUM;
     };
  
     public void setOUTLINE_CH_NUM(String OUTLINE_CH_NUM){
            this.OUTLINE_CH_NUM=OUTLINE_CH_NUM;
     };
  
     public void setOUTLINE_E1_NUM(String OUTLINE_E1_NUM){
            this.OUTLINE_E1_NUM=OUTLINE_E1_NUM;
     };
  ...
  public String toString(){
      ...
      strB.append("INLINE_NUM:"+ this.getINLINE_NUM()+"\n");
      
      strB.append("OUTLINE_CH_NUM:"+ this.getOUTLINE_CH_NUM()+"\n");
      
      strB.append("OUTLINE_E1_NUM:"+ this.getOUTLINE_E1_NUM()+"\n");
  ...
  public String getPrefix(){
    return PT_C_RES_SWITHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_C_RES_SWITHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_C_RES_SWITHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_C_RES_SWITHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_C_RES_SWITHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_C_RES_SWITEntity();
  }

  public ValueObject getClone(){
         PT_C_RES_SWITEntity newEnt = new PT_C_RES_SWITEntity();
          ...
          newEnt.setINLINE_NUM(this.getINLINE_NUM());
         
          newEnt.setOUTLINE_CH_NUM(this.getOUTLINE_CH_NUM());
         
          newEnt.setOUTLINE_E1_NUM(this.getOUTLINE_E1_NUM());
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_C_RES_SWITHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
             ...
             case 5 :
                 return  this.getINLINE_NUM();
        
             case 6 :
                 return  this.getOUTLINE_CH_NUM();
        
             case 7 :
                 return  this.getOUTLINE_E1_NUM();
  ...
  public void   setByName(String key, Object value){
	 ...
	 if(idx !=null)
	    switch(idx.intValue()){
             ...
             case 5 :
                    this.setINLINE_NUM((String)value);
	            return;  
        
             case 6 :
                    this.setOUTLINE_CH_NUM((String)value);
	            return;  
        
             case 7 :
                    this.setOUTLINE_E1_NUM((String)value);
	            return;  
  ...
  public String toXML(){
         return PT_C_RES_SWITHelper.toXML(this);
  }
