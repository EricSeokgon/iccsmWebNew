...
public class PT_M_MASTER_TEMPEntity extends ValueObject{
...
//생성자를 만든다
    public PT_M_MASTER_TEMPEntity(){
    }
    
      
    public PT_M_MASTER_TEMPEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_M_MASTER_TEMPHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_M_MASTER_TEMPHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_M_MASTER_TEMPHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_M_MASTER_TEMPHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_M_MASTER_TEMPHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_M_MASTER_TEMPEntity();
  }

  public ValueObject getClone(){
         PT_M_MASTER_TEMPEntity newEnt = new PT_M_MASTER_TEMPEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_M_MASTER_TEMPHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_M_MASTER_TEMPHelper.toXML(this);
  }
