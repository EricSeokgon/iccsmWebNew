...
public class PT_UB_CON_DETAILEntity extends ValueObject{
...
//생성자를 만든다
    public PT_UB_CON_DETAILEntity(){
    }
    
    
    public PT_UB_CON_DETAILEntity(String RECV_NUM,String SEQ,String SIDO_CODE,String SIGUNGU_CODE,String SRL ){
    ...
    public PT_UB_CON_DETAILEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_UB_CON_DETAILHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_UB_CON_DETAILHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_UB_CON_DETAILHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_UB_CON_DETAILHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_UB_CON_DETAILHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_UB_CON_DETAILEntity();
  }

  public ValueObject getClone(){
         PT_UB_CON_DETAILEntity newEnt = new PT_UB_CON_DETAILEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_UB_CON_DETAILHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_UB_CON_DETAILHelper.toXML(this);
  }
