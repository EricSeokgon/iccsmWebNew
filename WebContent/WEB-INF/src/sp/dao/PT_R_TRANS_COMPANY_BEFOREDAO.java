...
public class PT_R_TRANS_COMPANY_BEFOREDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_R_TRANS_COMPANY_BEFOREEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_TRANS_COMPANY_BEFORE : insert() ");
    }
    PT_R_TRANS_COMPANY_BEFOREEntity entity = (PT_R_TRANS_COMPANY_BEFOREEntity)obj;
  ...
  sb.append("insert into PT_R_TRANS_COMPANY_BEFORE ")
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_TRANS_COMPANY_BEFOREEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_TRANS_COMPANY_BEFORE : update() ");
    }
    PT_R_TRANS_COMPANY_BEFOREEntity entity = (PT_R_TRANS_COMPANY_BEFOREEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_R_TRANS_COMPANY_BEFORE  set ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_R_TRANS_COMPANY_BEFOREEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_TRANS_COMPANY_BEFORE : updateModifiedOnly() ");
    }
    PT_R_TRANS_COMPANY_BEFOREEntity entity = (PT_R_TRANS_COMPANY_BEFOREEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_TRANS_COMPANY_BEFOREEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_TRANS_COMPANY_BEFORE : delete() ");
    }
    PT_R_TRANS_COMPANY_BEFOREEntity entity = (PT_R_TRANS_COMPANY_BEFOREEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_R_TRANS_COMPANY_BEFORE  where  1=1")
