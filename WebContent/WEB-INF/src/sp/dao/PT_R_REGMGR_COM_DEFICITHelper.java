...
public class PT_R_REGMGR_COM_DEFICITHelper{
  ...
  fieldMap.put(INS_DT,new Integer(7) );
     ...
     final public static String TABLE = "PT_R_REGMGR_COM_DEFICIT";
     final public static String PREFIX = "sp.dao.PT_R_REGMGR_COM_DEFICIT";
   ...
   public static String toXML(PT_R_REGMGR_COM_DEFICITEntity ent){
