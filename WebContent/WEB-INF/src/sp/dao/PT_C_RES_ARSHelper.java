...
public class PT_C_RES_ARSHelper{
  ...
  fieldMap.put(ESTAB_AOM,new Integer(13) );
     ...
     final public static String TABLE = "PT_C_RES_ARS";
     final public static String PREFIX = "sp.dao.PT_C_RES_ARS";
   ...
   public static String toXML(PT_C_RES_ARSEntity ent){
