...
public class PT_C_RES_CHARGE_EQUEntity extends ValueObject{
...
//생성자를 만든다
    public PT_C_RES_CHARGE_EQUEntity(){
    }
    
    
    public PT_C_RES_CHARGE_EQUEntity(String SEQ ){
       this.setSEQ(SEQ);
       
    }
      
    public PT_C_RES_CHARGE_EQUEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_C_RES_CHARGE_EQUHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_C_RES_CHARGE_EQUHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_C_RES_CHARGE_EQUHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_C_RES_CHARGE_EQUHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_C_RES_CHARGE_EQUHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_C_RES_CHARGE_EQUEntity();
  }

  public ValueObject getClone(){
         PT_C_RES_CHARGE_EQUEntity newEnt = new PT_C_RES_CHARGE_EQUEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_C_RES_CHARGE_EQUHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_C_RES_CHARGE_EQUHelper.toXML(this);
  }
