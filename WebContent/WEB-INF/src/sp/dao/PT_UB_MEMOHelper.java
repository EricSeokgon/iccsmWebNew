...
public class PT_UB_MEMOHelper{
  ...
  fieldMap.put(WRT_NAME,new Integer(11) );
     ...
     final public static String TABLE = "PT_UB_MEMO";
     final public static String PREFIX = "sp.dao.PT_UB_MEMO";
   ...
   public static String toXML(PT_UB_MEMOEntity ent){
