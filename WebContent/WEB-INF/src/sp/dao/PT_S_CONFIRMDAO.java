...
public class PT_S_CONFIRMDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_S_CONFIRMEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_S_CONFIRM : insert() ");
    }
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_S_CONFIRMEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_S_CONFIRM : update() ");
    }
    PT_S_CONFIRMEntity entity = (PT_S_CONFIRMEntity)obj;
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_S_CONFIRMEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_S_CONFIRM : updateModifiedOnly() ");
    }
    PT_S_CONFIRMEntity entity = (PT_S_CONFIRMEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_S_CONFIRMEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_S_CONFIRM : delete() ");
    }
    PT_S_CONFIRMEntity entity = (PT_S_CONFIRMEntity)obj;
