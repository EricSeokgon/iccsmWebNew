...
public class PT_UB_CONDEFICITDAO  extends SuperToDB{

  private String default_fields[]={ "DEFI_SEQ" , "DEFI_CODE" , "DEFI_OUT" , "WRT_ID" , "UPD_DT" , "INS_DT" , "RECV_NUM" , "SIDO_CODE" , "SIGUNGU_CODE" };	

  public int insert( ValueObject  obj) throws SQLException{

    if((obj instanceof PT_UB_CONDEFICITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_CONDEFICIT : insert() ");
    }
    PT_UB_CONDEFICITEntity entity = (PT_UB_CONDEFICITEntity)obj;
  ...
  sb.append("insert into PT_UB_CONDEFICIT ")
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_UB_CONDEFICITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_CONDEFICIT : update() ");
    }
    PT_UB_CONDEFICITEntity entity = (PT_UB_CONDEFICITEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_UB_CONDEFICIT  set ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_UB_CONDEFICITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_CONDEFICIT : updateModifiedOnly() ");
    }
    PT_UB_CONDEFICITEntity entity = (PT_UB_CONDEFICITEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_UB_CONDEFICITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_CONDEFICIT : delete() ");
    }
    PT_UB_CONDEFICITEntity entity = (PT_UB_CONDEFICITEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_UB_CONDEFICIT  where  1=1")
