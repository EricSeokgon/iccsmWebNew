...
public class PT_C_RES_IMAGE_TELEntity extends ValueObject{
...
//생성자를 만든다
    public PT_C_RES_IMAGE_TELEntity(){
    }
    
    
    public PT_C_RES_IMAGE_TELEntity(String SEQ ){
       this.setSEQ(SEQ);
       
    }
      
    public PT_C_RES_IMAGE_TELEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_C_RES_IMAGE_TELHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_C_RES_IMAGE_TELHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_C_RES_IMAGE_TELHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_C_RES_IMAGE_TELHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_C_RES_IMAGE_TELHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_C_RES_IMAGE_TELEntity();
  }

  public ValueObject getClone(){
         PT_C_RES_IMAGE_TELEntity newEnt = new PT_C_RES_IMAGE_TELEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_C_RES_IMAGE_TELHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_C_RES_IMAGE_TELHelper.toXML(this);
  }
