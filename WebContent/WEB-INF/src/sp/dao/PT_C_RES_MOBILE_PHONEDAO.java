...
public class PT_C_RES_MOBILE_PHONEDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_MOBILE_PHONEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_MOBILE_PHONE : insert() ");
    }
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_MOBILE_PHONEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_MOBILE_PHONE : update() ");
    }
    PT_C_RES_MOBILE_PHONEEntity entity = (PT_C_RES_MOBILE_PHONEEntity)obj;
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_MOBILE_PHONEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_MOBILE_PHONE : updateModifiedOnly() ");
    }
    PT_C_RES_MOBILE_PHONEEntity entity = (PT_C_RES_MOBILE_PHONEEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_MOBILE_PHONEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_MOBILE_PHONE : delete() ");
    }
    PT_C_RES_MOBILE_PHONEEntity entity = (PT_C_RES_MOBILE_PHONEEntity)obj;
