...
public class PT_HOM_VISIT_DAY_COUNTDAO  extends SuperToDB{

  private String default_fields[]={ "REG_DATE" , "D_01" , "D_02" , "D_03" , "D_04" , "D_05" , "D_06" , "D_07" , "D_08" , "D_09" , "D_10" , "D_11" , "D_12" , "D_13" , "D_14" , "D_15" , "D_16" , "D_17" , "D_18" , "D_19" , "D_20" , "D_21" , "D_22" , "D_23" , "D_24" , "D_25" , "D_26" , "D_27" , "D_28" , "D_29" , "D_30" , "D_31" , "MONTH_TOTAL" };	

  public int insert( ValueObject  obj) throws SQLException{

    if((obj instanceof PT_HOM_VISIT_DAY_COUNTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_HOM_VISIT_DAY_COUNT : insert() ");
    }
    PT_HOM_VISIT_DAY_COUNTEntity entity = (PT_HOM_VISIT_DAY_COUNTEntity)obj;
  ...
  sb.append("insert into PT_HOM_VISIT_DAY_COUNT ")
    .append(" ( REG_DATE,D_01,D_02,D_03,D_04,D_05,D_06,D_07,D_08,D_09,D_10,D_11,D_12,D_13,D_14,D_15,D_16,D_17,D_18,D_19,D_20,D_21,D_22,D_23,D_24,D_25,D_26,D_27,D_28,D_29,D_30,D_31,MONTH_TOTAL ) ")
    .append(" values ( ")
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_HOM_VISIT_DAY_COUNTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_HOM_VISIT_DAY_COUNT : update() ");
    }
    PT_HOM_VISIT_DAY_COUNTEntity entity = (PT_HOM_VISIT_DAY_COUNTEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_HOM_VISIT_DAY_COUNT  set ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_HOM_VISIT_DAY_COUNTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_HOM_VISIT_DAY_COUNT : updateModifiedOnly() ");
    }
    PT_HOM_VISIT_DAY_COUNTEntity entity = (PT_HOM_VISIT_DAY_COUNTEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_HOM_VISIT_DAY_COUNTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_HOM_VISIT_DAY_COUNT : delete() ");
    }
    PT_HOM_VISIT_DAY_COUNTEntity entity = (PT_HOM_VISIT_DAY_COUNTEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_HOM_VISIT_DAY_COUNT  where  1=1")
