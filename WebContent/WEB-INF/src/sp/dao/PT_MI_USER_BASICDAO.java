...
public class PT_MI_USER_BASICDAO  extends SuperToDB{

  private String default_fields[]={ "OFFI_ID" , "NM" , "TEL" , "SIDO_CODE" , "SIGUNGU_CODE" , "PART" , "POS" , "GROUP_CODE" , "WRT_ID" , "INS_DT" , "UPD_DT" , "PASS" , "HOME_GROUP" , "MOBILE" , "E_MAIL" , "OFFSEAL" , "TEL1" , "TEL2" , "TEL3" , "MOBILE1" , "MOBILE2" , "MOBILE3" , "PHOTO" , "FAX1" , "FAX2" , "FAX3" , "FAX" };	

  public int insert( ValueObject  obj) throws SQLException{

    if((obj instanceof PT_MI_USER_BASICEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_MI_USER_BASIC : insert() ");
    }
    PT_MI_USER_BASICEntity entity = (PT_MI_USER_BASICEntity)obj;
  ...
  sb.append("insert into PT_MI_USER_BASIC ")
    .append(" ( OFFI_ID,NM,TEL,SIDO_CODE,SIGUNGU_CODE,PART,POS,GROUP_CODE,WRT_ID,INS_DT,UPD_DT,PASS,HOME_GROUP,MOBILE,E_MAIL,OFFSEAL,TEL1,TEL2,TEL3,MOBILE1,MOBILE2,MOBILE3,PHOTO,FAX1,FAX2,FAX3,FAX ) ")
    .append(" values ( ")
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_MI_USER_BASICEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_MI_USER_BASIC : update() ");
    }
    PT_MI_USER_BASICEntity entity = (PT_MI_USER_BASICEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_MI_USER_BASIC  set ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_MI_USER_BASICEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_MI_USER_BASIC : updateModifiedOnly() ");
    }
    PT_MI_USER_BASICEntity entity = (PT_MI_USER_BASICEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_MI_USER_BASICEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_MI_USER_BASIC : delete() ");
    }
    PT_MI_USER_BASICEntity entity = (PT_MI_USER_BASICEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_MI_USER_BASIC  where  1=1")
