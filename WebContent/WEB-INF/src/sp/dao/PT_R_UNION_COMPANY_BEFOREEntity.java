...
*  작  성  자 : 김경덕 
*
*  테이블 명   :PT_R_UNION_COMPANY_BEFORE
*  테이블 설명 :
*  테이블 PK   :  
*               RECV_NUM  
*               TMP_WRT_NUM
...
*               PCOM_SELECT:VARCHAR2(1):  
*               CHGBRE_SEQ:VARCHAR2(20):  
*               BUSS_YMD:VARCHAR2(8):  
...
public class PT_R_UNION_COMPANY_BEFOREEntity extends ValueObject{
...
//생성자를 만든다
    public PT_R_UNION_COMPANY_BEFOREEntity(){
    }
    
    
    public PT_R_UNION_COMPANY_BEFOREEntity(String RECV_NUM,String TMP_WRT_NUM ){
       this.setRECV_NUM(RECV_NUM);
       this.setTMP_WRT_NUM(TMP_WRT_NUM);
       
    }
      
    public PT_R_UNION_COMPANY_BEFOREEntity(ValueObject ent) throws Exception{
       Object value = null; 
    ...
    public void setRequestOnlyString(HttpServletRequest request) throws Exception{
		...
		this.PCOM_SELECT =request.getParameter("PCOM_SELECT");
    ...
    public void setDsOnlyString(Dataset ds, int arg_row) throws Exception{  
		...
		this.PCOM_SELECT =KJFMi.dsGet(ds, arg_row, "PCOM_SELECT");
...
//Setter 함수를 만든다
     ...
     public void setPCOM_SELECT(String PCOM_SELECT){
            this.PCOM_SELECT=PCOM_SELECT;
     };
  ...
  public String toString(){
      ...
      strB.append("PCOM_SELECT:"+ this.getPCOM_SELECT()+"\n");
  ...
  public String getPrefix(){
    return PT_R_UNION_COMPANY_BEFOREHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_R_UNION_COMPANY_BEFOREHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_R_UNION_COMPANY_BEFOREHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_R_UNION_COMPANY_BEFOREHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_R_UNION_COMPANY_BEFOREHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_R_UNION_COMPANY_BEFOREEntity();
  }

  public ValueObject getClone(){
         PT_R_UNION_COMPANY_BEFOREEntity newEnt = new PT_R_UNION_COMPANY_BEFOREEntity();
          ...
          newEnt.setPCOM_SELECT(this.getPCOM_SELECT());
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_R_UNION_COMPANY_BEFOREHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public void   setByName(String key, Object value){
	 ...
	 if(idx !=null)
	    switch(idx.intValue()){
             ...
             case 55 :
                    this.setPCOM_SELECT((String)value);
	            return;  
  ...
  public String toXML(){
         return PT_R_UNION_COMPANY_BEFOREHelper.toXML(this);
  }
