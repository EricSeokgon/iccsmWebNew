...
public class PT_R_WORK_RESULTSDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_R_WORK_RESULTSEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_WORK_RESULTS : insert() ");
    }
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_WORK_RESULTSEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_WORK_RESULTS : update() ");
    }
    PT_R_WORK_RESULTSEntity entity = (PT_R_WORK_RESULTSEntity)obj;
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_R_WORK_RESULTSEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_WORK_RESULTS : updateModifiedOnly() ");
    }
    PT_R_WORK_RESULTSEntity entity = (PT_R_WORK_RESULTSEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_WORK_RESULTSEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_WORK_RESULTS : delete() ");
    }
    PT_R_WORK_RESULTSEntity entity = (PT_R_WORK_RESULTSEntity)obj;
