...
public class PT_R_REGIST_STATEMENTDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_R_REGIST_STATEMENTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_REGIST_STATEMENT : insert() ");
    }
    PT_R_REGIST_STATEMENTEntity entity = (PT_R_REGIST_STATEMENTEntity)obj;
  ...
  sb.append("insert into PT_R_REGIST_STATEMENT ")
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_REGIST_STATEMENTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_REGIST_STATEMENT : update() ");
    }
    PT_R_REGIST_STATEMENTEntity entity = (PT_R_REGIST_STATEMENTEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_R_REGIST_STATEMENT  set ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_R_REGIST_STATEMENTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_REGIST_STATEMENT : updateModifiedOnly() ");
    }
    PT_R_REGIST_STATEMENTEntity entity = (PT_R_REGIST_STATEMENTEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_REGIST_STATEMENTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_REGIST_STATEMENT : delete() ");
    }
    PT_R_REGIST_STATEMENTEntity entity = (PT_R_REGIST_STATEMENTEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_R_REGIST_STATEMENT  where  1=1")
