...
public class PT_C_RES_IMAGE_SYSTEMHelper{
  ...
  fieldMap.put(ESTAB_AOM,new Integer(13) );
     ...
     final public static String TABLE = "PT_C_RES_IMAGE_SYSTEM";
     final public static String PREFIX = "sp.dao.PT_C_RES_IMAGE_SYSTEM";
   ...
   public static String toXML(PT_C_RES_IMAGE_SYSTEMEntity ent){
