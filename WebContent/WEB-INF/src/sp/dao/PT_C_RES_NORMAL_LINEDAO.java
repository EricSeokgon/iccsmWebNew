...
public class PT_C_RES_NORMAL_LINEDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_NORMAL_LINEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_NORMAL_LINE : insert() ");
    }
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_NORMAL_LINEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_NORMAL_LINE : update() ");
    }
    PT_C_RES_NORMAL_LINEEntity entity = (PT_C_RES_NORMAL_LINEEntity)obj;
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_NORMAL_LINEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_NORMAL_LINE : updateModifiedOnly() ");
    }
    PT_C_RES_NORMAL_LINEEntity entity = (PT_C_RES_NORMAL_LINEEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_NORMAL_LINEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_NORMAL_LINE : delete() ");
    }
    PT_C_RES_NORMAL_LINEEntity entity = (PT_C_RES_NORMAL_LINEEntity)obj;
