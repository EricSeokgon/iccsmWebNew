...
public class PT_UB_CONMEMOHelper{
  ...
  fieldMap.put(SIGUNGU_CODE,new Integer(9) );
     ...
     final public static String TABLE = "PT_UB_CONMEMO";
     final public static String PREFIX = "sp.dao.PT_UB_CONMEMO";
   ...
   public static String toXML(PT_UB_CONMEMOEntity ent){
