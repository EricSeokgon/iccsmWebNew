...
public class PT_C_RES_CHARGE_EQUHelper{
  ...
  fieldMap.put(ESTAB_AOM,new Integer(13) );
     ...
     final public static String TABLE = "PT_C_RES_CHARGE_EQU";
     final public static String PREFIX = "sp.dao.PT_C_RES_CHARGE_EQU";
   ...
   public static String toXML(PT_C_RES_CHARGE_EQUEntity ent){
