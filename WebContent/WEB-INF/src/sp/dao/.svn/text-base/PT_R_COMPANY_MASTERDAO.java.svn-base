...
public class PT_R_COMPANY_MASTERDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_R_COMPANY_MASTEREntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_COMPANY_MASTER : insert() ");
    }
    PT_R_COMPANY_MASTEREntity entity = (PT_R_COMPANY_MASTEREntity)obj;
  ...
  sb.append("insert into PT_R_COMPANY_MASTER ")
    ...
    .append(" values ( ")
           ...
           .append(toDB(entity.getREP_MOBILE3()))
			.append(",")
           .append(toDB(entity.getTRANS_UNION_PROC()))
			.append(",")
           .append(toDB(entity.getTRANS_UNION_PARENT()))
			.append(",")
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_COMPANY_MASTEREntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_COMPANY_MASTER : update() ");
    }
    PT_R_COMPANY_MASTEREntity entity = (PT_R_COMPANY_MASTEREntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_R_COMPANY_MASTER  set ")
        ...
        .append("TRANS_UNION_PROC = ")
        .append(toDB(entity.getTRANS_UNION_PROC())).append(",")
        .append("TRANS_UNION_PARENT = ")
        .append(toDB(entity.getTRANS_UNION_PARENT())).append(",")
        .append("GUBUN = ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_R_COMPANY_MASTEREntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_COMPANY_MASTER : updateModifiedOnly() ");
    }
    PT_R_COMPANY_MASTEREntity entity = (PT_R_COMPANY_MASTEREntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_COMPANY_MASTEREntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_COMPANY_MASTER : delete() ");
    }
    PT_R_COMPANY_MASTEREntity entity = (PT_R_COMPANY_MASTEREntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_R_COMPANY_MASTER  where  1=1")
