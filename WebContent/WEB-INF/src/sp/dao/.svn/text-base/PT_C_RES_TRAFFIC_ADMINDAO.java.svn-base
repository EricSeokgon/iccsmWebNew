...
public class PT_C_RES_TRAFFIC_ADMINDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_TRAFFIC_ADMINEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_TRAFFIC_ADMIN : insert() ");
    }
    PT_C_RES_TRAFFIC_ADMINEntity entity = (PT_C_RES_TRAFFIC_ADMINEntity)obj;
  ...
  sb.append("insert into PT_C_RES_TRAFFIC_ADMIN ")
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_TRAFFIC_ADMINEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_TRAFFIC_ADMIN : update() ");
    }
    PT_C_RES_TRAFFIC_ADMINEntity entity = (PT_C_RES_TRAFFIC_ADMINEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_C_RES_TRAFFIC_ADMIN  set ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_TRAFFIC_ADMINEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_TRAFFIC_ADMIN : updateModifiedOnly() ");
    }
    PT_C_RES_TRAFFIC_ADMINEntity entity = (PT_C_RES_TRAFFIC_ADMINEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_TRAFFIC_ADMINEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_TRAFFIC_ADMIN : delete() ");
    }
    PT_C_RES_TRAFFIC_ADMINEntity entity = (PT_C_RES_TRAFFIC_ADMINEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_C_RES_TRAFFIC_ADMIN  where  1=1")
