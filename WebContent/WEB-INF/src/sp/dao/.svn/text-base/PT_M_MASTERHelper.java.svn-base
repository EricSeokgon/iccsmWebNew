...
public class PT_M_MASTERHelper{
  ...
  public static HashMap fieldMap = new HashMap(58);
  static{
  ...
  fieldMap.put(BUSISUSP_START_DT,new Integer(26) );
  fieldMap.put(BUSISUSP_END_DT,new Integer(27) );
  fieldMap.put(DOC_CODE,new Integer(28) );
  fieldMap.put(PUNISHMENT_AGENCY,new Integer(29) );
  fieldMap.put(DISPO_CONT_NM,new Integer(30) );
  fieldMap.put(AT_RECV_NUM,new Integer(31) );
  fieldMap.put(MAST_PROC,new Integer(32) );
  fieldMap.put(COI_WRT_NUM,new Integer(33) );
    
  }

     final public static String PACKAGE = "sp.dao";
     final public static String TABLE = "PT_M_MASTER";
     final public static String PREFIX = "sp.dao.PT_M_MASTER";
   ...
   public static String toXML(PT_M_MASTEREntity ent){
