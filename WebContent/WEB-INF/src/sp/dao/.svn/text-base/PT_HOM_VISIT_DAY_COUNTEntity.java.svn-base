...
public class PT_HOM_VISIT_DAY_COUNTEntity extends ValueObject{
...
//생성자를 만든다
    public PT_HOM_VISIT_DAY_COUNTEntity(){
    }
    
    
    public PT_HOM_VISIT_DAY_COUNTEntity(String REG_DATE ){
       this.setREG_DATE(REG_DATE);
       
    }
      
    public PT_HOM_VISIT_DAY_COUNTEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_HOM_VISIT_DAY_COUNTHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_HOM_VISIT_DAY_COUNTHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_HOM_VISIT_DAY_COUNTHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_HOM_VISIT_DAY_COUNTHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_HOM_VISIT_DAY_COUNTHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_HOM_VISIT_DAY_COUNTEntity();
  }

  public ValueObject getClone(){
         PT_HOM_VISIT_DAY_COUNTEntity newEnt = new PT_HOM_VISIT_DAY_COUNTEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_HOM_VISIT_DAY_COUNTHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_HOM_VISIT_DAY_COUNTHelper.toXML(this);
  }
