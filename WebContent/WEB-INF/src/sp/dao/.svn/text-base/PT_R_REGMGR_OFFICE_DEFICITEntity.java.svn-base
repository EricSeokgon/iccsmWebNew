...
public class PT_R_REGMGR_OFFICE_DEFICITEntity extends ValueObject{
...
//생성자를 만든다
    public PT_R_REGMGR_OFFICE_DEFICITEntity(){
    }
    
    
    public PT_R_REGMGR_OFFICE_DEFICITEntity(String SEQ,String TMP_REG_NUM ){
       this.setSEQ(SEQ);
       this.setTMP_REG_NUM(TMP_REG_NUM);
       
    }
      
    public PT_R_REGMGR_OFFICE_DEFICITEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_R_REGMGR_OFFICE_DEFICITHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_R_REGMGR_OFFICE_DEFICITHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_R_REGMGR_OFFICE_DEFICITHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_R_REGMGR_OFFICE_DEFICITHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_R_REGMGR_OFFICE_DEFICITHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_R_REGMGR_OFFICE_DEFICITEntity();
  }

  public ValueObject getClone(){
         PT_R_REGMGR_OFFICE_DEFICITEntity newEnt = new PT_R_REGMGR_OFFICE_DEFICITEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_R_REGMGR_OFFICE_DEFICITHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_R_REGMGR_OFFICE_DEFICITHelper.toXML(this);
  }
