...
public class PT_M_MASTER_TEMPDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_M_MASTER_TEMPEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_M_MASTER_TEMP : insert() ");
    }
    PT_M_MASTER_TEMPEntity entity = (PT_M_MASTER_TEMPEntity)obj;
  ...
  sb.append("insert into PT_M_MASTER_TEMP ")
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_M_MASTER_TEMPEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_M_MASTER_TEMP : update() ");
    }
    PT_M_MASTER_TEMPEntity entity = (PT_M_MASTER_TEMPEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_M_MASTER_TEMP  set ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_M_MASTER_TEMPEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_M_MASTER_TEMP : updateModifiedOnly() ");
    }
    PT_M_MASTER_TEMPEntity entity = (PT_M_MASTER_TEMPEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_M_MASTER_TEMPEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_M_MASTER_TEMP : delete() ");
    }
    PT_M_MASTER_TEMPEntity entity = (PT_M_MASTER_TEMPEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_M_MASTER_TEMP  where  1=1")
       ;
