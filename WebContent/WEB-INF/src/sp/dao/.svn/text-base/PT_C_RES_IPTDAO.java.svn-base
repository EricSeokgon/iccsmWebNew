...
public class PT_C_RES_IPTDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_IPTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_IPT : insert() ");
    }
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_IPTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_IPT : update() ");
    }
    PT_C_RES_IPTEntity entity = (PT_C_RES_IPTEntity)obj;
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_IPTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_IPT : updateModifiedOnly() ");
    }
    PT_C_RES_IPTEntity entity = (PT_C_RES_IPTEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_IPTEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_IPT : delete() ");
    }
    PT_C_RES_IPTEntity entity = (PT_C_RES_IPTEntity)obj;
