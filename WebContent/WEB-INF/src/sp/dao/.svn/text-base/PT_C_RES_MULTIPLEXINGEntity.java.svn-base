...
public class PT_C_RES_MULTIPLEXINGEntity extends ValueObject{
...
//생성자를 만든다
    public PT_C_RES_MULTIPLEXINGEntity(){
    }
    
    
    public PT_C_RES_MULTIPLEXINGEntity(String SEQ ){
       this.setSEQ(SEQ);
       
    }
      
    public PT_C_RES_MULTIPLEXINGEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_C_RES_MULTIPLEXINGHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_C_RES_MULTIPLEXINGHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_C_RES_MULTIPLEXINGHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_C_RES_MULTIPLEXINGHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_C_RES_MULTIPLEXINGHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_C_RES_MULTIPLEXINGEntity();
  }

  public ValueObject getClone(){
         PT_C_RES_MULTIPLEXINGEntity newEnt = new PT_C_RES_MULTIPLEXINGEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_C_RES_MULTIPLEXINGHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_C_RES_MULTIPLEXINGHelper.toXML(this);
  }
