...
public class PT_C_RES_IMAGE_TELHelper{
  ...
  fieldMap.put(ESTAB_AOM,new Integer(13) );
     ...
     final public static String TABLE = "PT_C_RES_IMAGE_TEL";
     final public static String PREFIX = "sp.dao.PT_C_RES_IMAGE_TEL";
   ...
   public static String toXML(PT_C_RES_IMAGE_TELEntity ent){
