...
public class PT_MI_USER_BASICHelper{
  ...
  fieldMap.put(FAX,new Integer(27) );
     ...
     final public static String TABLE = "PT_MI_USER_BASIC";
     final public static String PREFIX = "sp.dao.PT_MI_USER_BASIC";
   ...
   public static String toXML(PT_MI_USER_BASICEntity ent){
