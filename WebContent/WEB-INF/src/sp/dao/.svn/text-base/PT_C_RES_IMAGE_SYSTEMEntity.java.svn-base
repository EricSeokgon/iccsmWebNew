...
public class PT_C_RES_IMAGE_SYSTEMEntity extends ValueObject{
...
//생성자를 만든다
    public PT_C_RES_IMAGE_SYSTEMEntity(){
    }
    
    
    public PT_C_RES_IMAGE_SYSTEMEntity(String SEQ ){
       this.setSEQ(SEQ);
       
    }
      
    public PT_C_RES_IMAGE_SYSTEMEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_C_RES_IMAGE_SYSTEMHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_C_RES_IMAGE_SYSTEMHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_C_RES_IMAGE_SYSTEMHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_C_RES_IMAGE_SYSTEMHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_C_RES_IMAGE_SYSTEMHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_C_RES_IMAGE_SYSTEMEntity();
  }

  public ValueObject getClone(){
         PT_C_RES_IMAGE_SYSTEMEntity newEnt = new PT_C_RES_IMAGE_SYSTEMEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_C_RES_IMAGE_SYSTEMHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_C_RES_IMAGE_SYSTEMHelper.toXML(this);
  }
