...
public class PT_M_SUSPENSIONDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_M_SUSPENSIONEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_M_SUSPENSION : insert() ");
    }
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_M_SUSPENSIONEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_M_SUSPENSION : update() ");
    }
    PT_M_SUSPENSIONEntity entity = (PT_M_SUSPENSIONEntity)obj;
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_M_SUSPENSIONEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_M_SUSPENSION : updateModifiedOnly() ");
    }
    PT_M_SUSPENSIONEntity entity = (PT_M_SUSPENSIONEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_M_SUSPENSIONEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_M_SUSPENSION : delete() ");
    }
    PT_M_SUSPENSIONEntity entity = (PT_M_SUSPENSIONEntity)obj;
