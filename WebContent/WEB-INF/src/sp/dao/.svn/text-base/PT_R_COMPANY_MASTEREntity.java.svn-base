...
public class PT_R_COMPANY_MASTEREntity extends ValueObject{
     ...
     private String TRANS_UNION_PROC;
  
     private String TRANS_UNION_PARENT;
     ...
     private String UNION_INVEST_NUM;
  
     private String MIDAL_YN;
  

//생성자를 만든다
    public PT_R_COMPANY_MASTEREntity(){
    }
    
    
    public PT_R_COMPANY_MASTEREntity(String TMP_WRT_NUM ){
       this.setTMP_WRT_NUM(TMP_WRT_NUM);
       
    }
      
    public PT_R_COMPANY_MASTEREntity(ValueObject ent) throws Exception{
       Object value = null; 
    ...
    public void setRequestOnlyString(HttpServletRequest request) throws Exception{
		...
		this.TRANS_UNION_PROC =request.getParameter("TRANS_UNION_PROC");
		this.TRANS_UNION_PARENT =request.getParameter("TRANS_UNION_PARENT");
		...
		this.UNION_INVEST_NUM =request.getParameter("UNION_INVEST_NUM");
		this.MIDAL_YN =request.getParameter("MIDAL_YN");
    ...
    public void setDsOnlyString(Dataset ds, int arg_row) throws Exception{  
		...
		this.TRANS_UNION_PROC =KJFMi.dsGet(ds, arg_row, "TRANS_UNION_PROC");
		this.TRANS_UNION_PARENT =KJFMi.dsGet(ds, arg_row, "TRANS_UNION_PARENT");
		...
		this.UNION_INVEST_NUM =KJFMi.dsGet(ds, arg_row, "UNION_INVEST_NUM");
		this.MIDAL_YN =KJFMi.dsGet(ds, arg_row, "MIDAL_YN");
...
//Getter 함수를 만든다
     ...
     public String getTRANS_UNION_PROC(){
             return TRANS_UNION_PROC;
     };
  
     public String getTRANS_UNION_PARENT(){
             return TRANS_UNION_PARENT;
     };
     ...
     public String getUNION_INVEST_NUM(){
             return UNION_INVEST_NUM;
     };
  
     public String getMIDAL_YN(){
             return MIDAL_YN;
     };
...
//Setter 함수를 만든다
     ...
     public void setTRANS_UNION_PROC(String TRANS_UNION_PROC){
            this.TRANS_UNION_PROC=TRANS_UNION_PROC;
     };
  
     public void setTRANS_UNION_PARENT(String TRANS_UNION_PARENT){
            this.TRANS_UNION_PARENT=TRANS_UNION_PARENT;
     };
     ...
     public void setUNION_INVEST_NUM(String UNION_INVEST_NUM){
            this.UNION_INVEST_NUM=UNION_INVEST_NUM;
     };
  
     public void setMIDAL_YN(String MIDAL_YN){
            this.MIDAL_YN=MIDAL_YN;
     };
  ...
  public String toString(){
      ...
      strB.append("TRANS_UNION_PROC:"+ this.getTRANS_UNION_PROC()+"\n");
      
      strB.append("TRANS_UNION_PARENT:"+ this.getTRANS_UNION_PARENT()+"\n");
      ...
      strB.append("UNION_INVEST_NUM:"+ this.getUNION_INVEST_NUM()+"\n");
      
      strB.append("MIDAL_YN:"+ this.getMIDAL_YN()+"\n");
  ...
  public String getPrefix(){
    return PT_R_COMPANY_MASTERHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_R_COMPANY_MASTERHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_R_COMPANY_MASTERHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_R_COMPANY_MASTERHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_R_COMPANY_MASTERHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_R_COMPANY_MASTEREntity();
  }

  public ValueObject getClone(){
         PT_R_COMPANY_MASTEREntity newEnt = new PT_R_COMPANY_MASTEREntity();
          ...
          newEnt.setTRANS_UNION_PROC(this.getTRANS_UNION_PROC());
         
          newEnt.setTRANS_UNION_PARENT(this.getTRANS_UNION_PARENT());
          ...
          newEnt.setUNION_INVEST_NUM(this.getUNION_INVEST_NUM());
         
          newEnt.setMIDAL_YN(this.getMIDAL_YN());
         
	 return newEnt;
  }

  public Object getByName(String key){
         Integer idx = (Integer)PT_R_COMPANY_MASTERHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
             ...
             case 54 :
                 return  this.getTRANS_UNION_PROC();
        
             case 55 :
                 return  this.getTRANS_UNION_PARENT();
             ...
             case 65 :
                 return  this.getUNION_INVEST_NUM();
        
             case 66 :
                 return  this.getMIDAL_YN();
  ...
  public void   setByName(String key, Object value){
	 ...
	 if(idx !=null)
	    switch(idx.intValue()){
             ...
             case 54 :
                    this.setTRANS_UNION_PROC((String)value);
	            return;  
        
             case 55 :
                    this.setTRANS_UNION_PARENT((String)value);
	            return;  
             ...
             case 65 :
                    this.setUNION_INVEST_NUM((String)value);
	            return;  
        
             case 66 :
                    this.setMIDAL_YN((String)value);
	            return;  
  ...
  public String toXML(){
         return PT_R_COMPANY_MASTERHelper.toXML(this);
  }
