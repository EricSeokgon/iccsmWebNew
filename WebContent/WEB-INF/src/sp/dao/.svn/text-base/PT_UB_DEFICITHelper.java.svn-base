...
public class PT_UB_DEFICITHelper{
  ...
  fieldMap.put(SIGUNGU_CODE,new Integer(9) );
     ...
     final public static String TABLE = "PT_UB_DEFICIT";
     final public static String PREFIX = "sp.dao.PT_UB_DEFICIT";
   ...
   public static String toXML(PT_UB_DEFICITEntity ent){
