...
public class PT_C_RES_TRAFFIC_ADMINEntity extends ValueObject{
...
//생성자를 만든다
    public PT_C_RES_TRAFFIC_ADMINEntity(){
    }
    
    
    public PT_C_RES_TRAFFIC_ADMINEntity(String SEQ ){
       this.setSEQ(SEQ);
       
    }
      
    public PT_C_RES_TRAFFIC_ADMINEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_C_RES_TRAFFIC_ADMINHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_C_RES_TRAFFIC_ADMINHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_C_RES_TRAFFIC_ADMINHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_C_RES_TRAFFIC_ADMINHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_C_RES_TRAFFIC_ADMINHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_C_RES_TRAFFIC_ADMINEntity();
  }

  public ValueObject getClone(){
         PT_C_RES_TRAFFIC_ADMINEntity newEnt = new PT_C_RES_TRAFFIC_ADMINEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_C_RES_TRAFFIC_ADMINHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_C_RES_TRAFFIC_ADMINHelper.toXML(this);
  }
