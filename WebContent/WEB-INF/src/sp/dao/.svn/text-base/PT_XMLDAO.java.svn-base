...
public class PT_XMLDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_XMLEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_XML : insert() ");
    }
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_XMLEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_XML : update() ");
    }
    PT_XMLEntity entity = (PT_XMLEntity)obj;
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_XMLEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_XML : updateModifiedOnly() ");
    }
    PT_XMLEntity entity = (PT_XMLEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_XMLEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_XML : delete() ");
    }
    PT_XMLEntity entity = (PT_XMLEntity)obj;
