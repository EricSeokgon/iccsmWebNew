...
public class PT_UB_CONDEFICITHelper{
  ...
  fieldMap.put(SIGUNGU_CODE,new Integer(9) );
     ...
     final public static String TABLE = "PT_UB_CONDEFICIT";
     final public static String PREFIX = "sp.dao.PT_UB_CONDEFICIT";
   ...
   public static String toXML(PT_UB_CONDEFICITEntity ent){
