...
public class PT_UB_DETAILDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_UB_DETAILEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_DETAIL : insert() ");
    }
    PT_UB_DETAILEntity entity = (PT_UB_DETAILEntity)obj;
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_UB_DETAILEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_DETAIL : update() ");
    }
    PT_UB_DETAILEntity entity = (PT_UB_DETAILEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_UB_DETAIL  set ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_UB_DETAILEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_DETAIL : updateModifiedOnly() ");
    }
    PT_UB_DETAILEntity entity = (PT_UB_DETAILEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_UB_DETAILEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_DETAIL : delete() ");
    }
    PT_UB_DETAILEntity entity = (PT_UB_DETAILEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_UB_DETAIL  where  1=1")
