...
public class PT_C_RES_TRAFFIC_ADMINHelper{
  ...
  fieldMap.put(TRAFFIC_LINE,new Integer(15) );
     ...
     final public static String TABLE = "PT_C_RES_TRAFFIC_ADMIN";
     final public static String PREFIX = "sp.dao.PT_C_RES_TRAFFIC_ADMIN";
   ...
   public static String toXML(PT_C_RES_TRAFFIC_ADMINEntity ent){
