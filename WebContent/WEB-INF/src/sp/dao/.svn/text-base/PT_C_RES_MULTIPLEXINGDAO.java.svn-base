...
public class PT_C_RES_MULTIPLEXINGDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_MULTIPLEXINGEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_MULTIPLEXING : insert() ");
    }
    PT_C_RES_MULTIPLEXINGEntity entity = (PT_C_RES_MULTIPLEXINGEntity)obj;
  ...
  sb.append("insert into PT_C_RES_MULTIPLEXING ")
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_MULTIPLEXINGEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_MULTIPLEXING : update() ");
    }
    PT_C_RES_MULTIPLEXINGEntity entity = (PT_C_RES_MULTIPLEXINGEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_C_RES_MULTIPLEXING  set ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_MULTIPLEXINGEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_MULTIPLEXING : updateModifiedOnly() ");
    }
    PT_C_RES_MULTIPLEXINGEntity entity = (PT_C_RES_MULTIPLEXINGEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_MULTIPLEXINGEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_MULTIPLEXING : delete() ");
    }
    PT_C_RES_MULTIPLEXINGEntity entity = (PT_C_RES_MULTIPLEXINGEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_C_RES_MULTIPLEXING  where  1=1")
