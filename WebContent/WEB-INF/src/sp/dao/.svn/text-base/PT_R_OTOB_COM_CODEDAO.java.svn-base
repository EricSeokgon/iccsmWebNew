...
public class PT_R_OTOB_COM_CODEDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_R_OTOB_COM_CODEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_OTOB_COM_CODE : insert() ");
    }
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_OTOB_COM_CODEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_OTOB_COM_CODE : update() ");
    }
    PT_R_OTOB_COM_CODEEntity entity = (PT_R_OTOB_COM_CODEEntity)obj;
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_R_OTOB_COM_CODEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_OTOB_COM_CODE : updateModifiedOnly() ");
    }
    PT_R_OTOB_COM_CODEEntity entity = (PT_R_OTOB_COM_CODEEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_OTOB_COM_CODEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_OTOB_COM_CODE : delete() ");
    }
    PT_R_OTOB_COM_CODEEntity entity = (PT_R_OTOB_COM_CODEEntity)obj;
