...
public class PT_R_MEMODAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_R_MEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_MEMO : insert() ");
    }
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_MEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_MEMO : update() ");
    }
    PT_R_MEMOEntity entity = (PT_R_MEMOEntity)obj;
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_R_MEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_MEMO : updateModifiedOnly() ");
    }
    PT_R_MEMOEntity entity = (PT_R_MEMOEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_MEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_MEMO : delete() ");
    }
    PT_R_MEMOEntity entity = (PT_R_MEMOEntity)obj;
