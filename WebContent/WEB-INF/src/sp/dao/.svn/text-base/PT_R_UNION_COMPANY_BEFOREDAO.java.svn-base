...
public class PT_R_UNION_COMPANY_BEFOREDAO  extends SuperToDB{

  private String default_fields[]={ "TMP_WRT_NUM" , "SIDO_CODE" , "COMMANA_CLASS" , "MANA_NUM" , "NAME" , "REP_SSN1" , "REP_SSN2" , "REP_NM_KOR" , "REP_NM_HAN" , "REP_TEL_NUM" , "ADDR_POST_NUM" , "ADDR_ADDR" , "ADDR_DETAIL_ADDR" , "ADDR_TEL_NUM" , "ADDR_FAX_NUM" , "EMAIL_ADDR" , "OFFICE_AREA" , "OFFICE_USE_CODE" , "COMPANY_DIAG_CLASS_CODE" , "COMPANY_DIAG_BAS_DT" , "COMPANY_DIAG_ISSUE_DT" , "DIAG_ORG_CODE" , "DIAG_NM_NM" , "DIAG_NM_WRT_NUM" , "PAY_CAP" , "REA_CAP" , "TUP_AOM" , "TUP_CLASS_CODE" , "C_COM_DT" , "C_COM_CAUSE_CODE" , "COM_COV_DT" , "WRT_ID" , "UPD_DT" , "INS_DT" , "WRT_DT" , "BAS_STA_DT" , "OFFICE_OWN_CLASS" , "COI_WRT_NUM" , "REP_MOBILE" , "LICTAX" , "HOSCRE" , "SND_DT" , "SND_STE" , "COM_NUM" , "ADDR_TEL_NUM1" , "ADDR_TEL_NUM2" , "ADDR_TEL_NUM3" , "ADDR_FAX_NUM1" , "ADDR_FAX_NUM2" , "ADDR_FAX_NUM3" , "REP_MOBILE1" , "REP_MOBILE2" , "REP_MOBILE3" , "RECV_NUM" , "PCOM_SELECT" , "CHGBRE_SEQ" , "BUSS_YMD" , "FOREIGN_YN" , "REGIST_YMD" };	

  public int insert( ValueObject  obj) throws SQLException{

    if((obj instanceof PT_R_UNION_COMPANY_BEFOREEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_UNION_COMPANY_BEFORE : insert() ");
    }
    PT_R_UNION_COMPANY_BEFOREEntity entity = (PT_R_UNION_COMPANY_BEFOREEntity)obj;
  ...
  sb.append("insert into PT_R_UNION_COMPANY_BEFORE ")
    ...
    .append(" values ( ")
           ...
           .append(toDB(entity.getRECV_NUM()))
			.append(",")
           .append(toDB(entity.getPCOM_SELECT()))
			.append(",")
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_UNION_COMPANY_BEFOREEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_UNION_COMPANY_BEFORE : update() ");
    }
    PT_R_UNION_COMPANY_BEFOREEntity entity = (PT_R_UNION_COMPANY_BEFOREEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_R_UNION_COMPANY_BEFORE  set ")
        ...
        .append("PCOM_SELECT = ")
        .append(toDB(entity.getPCOM_SELECT())).append(",")
        .append("CHGBRE_SEQ = ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_R_UNION_COMPANY_BEFOREEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_UNION_COMPANY_BEFORE : updateModifiedOnly() ");
    }
    PT_R_UNION_COMPANY_BEFOREEntity entity = (PT_R_UNION_COMPANY_BEFOREEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_UNION_COMPANY_BEFOREEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_UNION_COMPANY_BEFORE : delete() ");
    }
    PT_R_UNION_COMPANY_BEFOREEntity entity = (PT_R_UNION_COMPANY_BEFOREEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_R_UNION_COMPANY_BEFORE  where  1=1")
