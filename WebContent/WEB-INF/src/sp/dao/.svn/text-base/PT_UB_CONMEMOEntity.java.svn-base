...
public class PT_UB_CONMEMOEntity extends ValueObject{
...
//생성자를 만든다
    public PT_UB_CONMEMOEntity(){
    }
    
    
    public PT_UB_CONMEMOEntity(String RECV_NUM,String SEQ,String SIDO_CODE,String SIGUNGU_CODE ){
    ...
    public PT_UB_CONMEMOEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_UB_CONMEMOHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_UB_CONMEMOHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_UB_CONMEMOHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_UB_CONMEMOHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_UB_CONMEMOHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_UB_CONMEMOEntity();
  }

  public ValueObject getClone(){
         PT_UB_CONMEMOEntity newEnt = new PT_UB_CONMEMOEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_UB_CONMEMOHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_UB_CONMEMOHelper.toXML(this);
  }
