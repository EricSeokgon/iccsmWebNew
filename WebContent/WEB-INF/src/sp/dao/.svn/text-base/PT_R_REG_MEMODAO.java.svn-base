...
public class PT_R_REG_MEMODAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_R_REG_MEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_REG_MEMO : insert() ");
    }
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_REG_MEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_REG_MEMO : update() ");
    }
    PT_R_REG_MEMOEntity entity = (PT_R_REG_MEMOEntity)obj;
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_R_REG_MEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_REG_MEMO : updateModifiedOnly() ");
    }
    PT_R_REG_MEMOEntity entity = (PT_R_REG_MEMOEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_REG_MEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_REG_MEMO : delete() ");
    }
    PT_R_REG_MEMOEntity entity = (PT_R_REG_MEMOEntity)obj;
