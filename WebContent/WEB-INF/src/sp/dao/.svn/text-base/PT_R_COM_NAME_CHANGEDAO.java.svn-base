...
public class PT_R_COM_NAME_CHANGEDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_R_COM_NAME_CHANGEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_COM_NAME_CHANGE : insert() ");
    }
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_COM_NAME_CHANGEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_COM_NAME_CHANGE : update() ");
    }
    PT_R_COM_NAME_CHANGEEntity entity = (PT_R_COM_NAME_CHANGEEntity)obj;
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_R_COM_NAME_CHANGEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_COM_NAME_CHANGE : updateModifiedOnly() ");
    }
    PT_R_COM_NAME_CHANGEEntity entity = (PT_R_COM_NAME_CHANGEEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_COM_NAME_CHANGEEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_COM_NAME_CHANGE : delete() ");
    }
    PT_R_COM_NAME_CHANGEEntity entity = (PT_R_COM_NAME_CHANGEEntity)obj;
