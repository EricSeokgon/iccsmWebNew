...
public class PT_UB_MEMOEntity extends ValueObject{
...
//생성자를 만든다
    public PT_UB_MEMOEntity(){
    }
    
    
    public PT_UB_MEMOEntity(String RECV_NUM,String SEQ,String SIDO_CODE,String SIGUNGU_CODE ){
    ...
    public PT_UB_MEMOEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_UB_MEMOHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_UB_MEMOHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_UB_MEMOHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_UB_MEMOHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_UB_MEMOHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_UB_MEMOEntity();
  }

  public ValueObject getClone(){
         PT_UB_MEMOEntity newEnt = new PT_UB_MEMOEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_UB_MEMOHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_UB_MEMOHelper.toXML(this);
  }
