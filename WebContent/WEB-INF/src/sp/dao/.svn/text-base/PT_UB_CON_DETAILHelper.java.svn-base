...
public class PT_UB_CON_DETAILHelper{
  ...
  fieldMap.put(SIGUNGU_CODE,new Integer(10) );
     ...
     final public static String TABLE = "PT_UB_CON_DETAIL";
     final public static String PREFIX = "sp.dao.PT_UB_CON_DETAIL";
   ...
   public static String toXML(PT_UB_CON_DETAILEntity ent){
