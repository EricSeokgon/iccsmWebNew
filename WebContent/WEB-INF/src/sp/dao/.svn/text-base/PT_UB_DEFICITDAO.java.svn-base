...
public class PT_UB_DEFICITDAO  extends SuperToDB{

  private String default_fields[]={ "DEFI_SEQ" , "DEFI_CODE" , "DEFI_OUT" , "WRT_ID" , "UPD_DT" , "INS_DT" , "RECV_NUM" , "SIDO_CODE" , "SIGUNGU_CODE" };	

  public int insert( ValueObject  obj) throws SQLException{

    if((obj instanceof PT_UB_DEFICITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_DEFICIT : insert() ");
    }
    PT_UB_DEFICITEntity entity = (PT_UB_DEFICITEntity)obj;
  ...
  sb.append("insert into PT_UB_DEFICIT ")
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_UB_DEFICITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_DEFICIT : update() ");
    }
    PT_UB_DEFICITEntity entity = (PT_UB_DEFICITEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_UB_DEFICIT  set ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_UB_DEFICITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_DEFICIT : updateModifiedOnly() ");
    }
    PT_UB_DEFICITEntity entity = (PT_UB_DEFICITEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_UB_DEFICITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_DEFICIT : delete() ");
    }
    PT_UB_DEFICITEntity entity = (PT_UB_DEFICITEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_UB_DEFICIT  where  1=1")
