...
public class PT_R_REGMGR_DIA_DEFICITDAO  extends SuperToDB{

  private String default_fields[]={ "TMP_REG_NUM" , "SEQ" , "DEFICIT_CODE" , "DEFICIT_RESULT" , "WRT_ID" , "UPD_DT" , "INS_DT" };	

  public int insert( ValueObject  obj) throws SQLException{

    if((obj instanceof PT_R_REGMGR_DIA_DEFICITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_REGMGR_DIA_DEFICIT : insert() ");
    }
    PT_R_REGMGR_DIA_DEFICITEntity entity = (PT_R_REGMGR_DIA_DEFICITEntity)obj;
  ...
  sb.append("insert into PT_R_REGMGR_DIA_DEFICIT ")
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_REGMGR_DIA_DEFICITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_REGMGR_DIA_DEFICIT : update() ");
    }
    PT_R_REGMGR_DIA_DEFICITEntity entity = (PT_R_REGMGR_DIA_DEFICITEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_R_REGMGR_DIA_DEFICIT  set ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_R_REGMGR_DIA_DEFICITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_REGMGR_DIA_DEFICIT : updateModifiedOnly() ");
    }
    PT_R_REGMGR_DIA_DEFICITEntity entity = (PT_R_REGMGR_DIA_DEFICITEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_R_REGMGR_DIA_DEFICITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_R_REGMGR_DIA_DEFICIT : delete() ");
    }
    PT_R_REGMGR_DIA_DEFICITEntity entity = (PT_R_REGMGR_DIA_DEFICITEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_R_REGMGR_DIA_DEFICIT  where  1=1")
