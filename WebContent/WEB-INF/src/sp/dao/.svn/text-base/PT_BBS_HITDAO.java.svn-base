...
public class PT_BBS_HITDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_BBS_HITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_BBS_HIT : insert() ");
    }
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_BBS_HITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_BBS_HIT : update() ");
    }
    PT_BBS_HITEntity entity = (PT_BBS_HITEntity)obj;
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_BBS_HITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_BBS_HIT : updateModifiedOnly() ");
    }
    PT_BBS_HITEntity entity = (PT_BBS_HITEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_BBS_HITEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_BBS_HIT : delete() ");
    }
    PT_BBS_HITEntity entity = (PT_BBS_HITEntity)obj;
