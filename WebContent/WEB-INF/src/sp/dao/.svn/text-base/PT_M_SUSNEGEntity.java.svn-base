...
public class PT_M_SUSNEGEntity extends ValueObject{
     ...
     private String PAYLIM;
  

//생성자를 만든다
    public PT_M_SUSNEGEntity(){
    }
    
    
    public PT_M_SUSNEGEntity(String TMP_WRT_NUM,String WRT_NUM ){
       this.setTMP_WRT_NUM(TMP_WRT_NUM);
       this.setWRT_NUM(WRT_NUM);
       
    }
      
    public PT_M_SUSNEGEntity(ValueObject ent) throws Exception{
       Object value = null; 
    ...
    public void setRequestOnlyString(HttpServletRequest request) throws Exception{
		...
		this.PAYLIM =request.getParameter("PAYLIM");
    ...
    public void setDsOnlyString(Dataset ds, int arg_row) throws Exception{  
		...
		this.PAYLIM =KJFMi.dsGet(ds, arg_row, "PAYLIM");
...
//Setter 함수를 만든다
     ...
     public void setPAYLIM(String PAYLIM){
            this.PAYLIM=PAYLIM;
     };
  ...
  public String toString(){
      ...
      strB.append("PAYLIM:"+ this.getPAYLIM()+"\n");
  ...
  public String getPrefix(){
    return PT_M_SUSNEGHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_M_SUSNEGHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_M_SUSNEGHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_M_SUSNEGHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_M_SUSNEGHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_M_SUSNEGEntity();
  }

  public ValueObject getClone(){
         PT_M_SUSNEGEntity newEnt = new PT_M_SUSNEGEntity();
          ...
          newEnt.setPAYLIM(this.getPAYLIM());
         
	 return newEnt;
  }

  public Object getByName(String key){
         Integer idx = (Integer)PT_M_SUSNEGHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_M_SUSNEGHelper.toXML(this);
  }
