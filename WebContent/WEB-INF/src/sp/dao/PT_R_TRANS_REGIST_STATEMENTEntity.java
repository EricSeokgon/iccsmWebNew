...
public class PT_R_TRANS_REGIST_STATEMENTEntity extends ValueObject{
...
//생성자를 만든다
    public PT_R_TRANS_REGIST_STATEMENTEntity(){
    }
    
    
    public PT_R_TRANS_REGIST_STATEMENTEntity(String RECV_NUM,String SIDO_CODE ){
       this.setRECV_NUM(RECV_NUM);
       this.setSIDO_CODE(SIDO_CODE);
       
    }
      
    public PT_R_TRANS_REGIST_STATEMENTEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_R_TRANS_REGIST_STATEMENTHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_R_TRANS_REGIST_STATEMENTHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_R_TRANS_REGIST_STATEMENTHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_R_TRANS_REGIST_STATEMENTHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_R_TRANS_REGIST_STATEMENTHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_R_TRANS_REGIST_STATEMENTEntity();
  }

  public ValueObject getClone(){
         PT_R_TRANS_REGIST_STATEMENTEntity newEnt = new PT_R_TRANS_REGIST_STATEMENTEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_R_TRANS_REGIST_STATEMENTHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_R_TRANS_REGIST_STATEMENTHelper.toXML(this);
  }
