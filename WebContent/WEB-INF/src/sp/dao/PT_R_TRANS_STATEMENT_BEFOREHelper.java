...
public class PT_R_TRANS_STATEMENT_BEFOREHelper{
  ...
  public static HashMap fieldMap = new HashMap(53);
  static{
  ...
  fieldMap.put(REP_MOBILE3,new Integer(53) );
     ...
     final public static String TABLE = "PT_R_TRANS_STATEMENT_BEFORE";
     final public static String PREFIX = "sp.dao.PT_R_TRANS_STATEMENT_BEFORE";
   ...
   public static String toXML(PT_R_TRANS_STATEMENT_BEFOREEntity ent){
