...
public class PT_HMS_COM_CODEEntity extends ValueObject{
...
//생성자를 만든다
    public PT_HMS_COM_CODEEntity(){
    }
    
    
    public PT_HMS_COM_CODEEntity(String CODE,String CODE_GROUP ){
       this.setCODE(CODE);
       this.setCODE_GROUP(CODE_GROUP);
       
    }
      
    public PT_HMS_COM_CODEEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_HMS_COM_CODEHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_HMS_COM_CODEHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_HMS_COM_CODEHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_HMS_COM_CODEHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_HMS_COM_CODEHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_HMS_COM_CODEEntity();
  }

  public ValueObject getClone(){
         PT_HMS_COM_CODEEntity newEnt = new PT_HMS_COM_CODEEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_HMS_COM_CODEHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_HMS_COM_CODEHelper.toXML(this);
  }
