...
public class PT_UB_SUVDEFICITEntity extends ValueObject{
...
//생성자를 만든다
    public PT_UB_SUVDEFICITEntity(){
    }
    
    
    public PT_UB_SUVDEFICITEntity(String DEFI_SEQ,String RECV_NUM,String SIDO_CODE,String SIGUNGU_CODE ){
    ...
    public PT_UB_SUVDEFICITEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_UB_SUVDEFICITHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_UB_SUVDEFICITHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_UB_SUVDEFICITHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_UB_SUVDEFICITHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_UB_SUVDEFICITHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_UB_SUVDEFICITEntity();
  }

  public ValueObject getClone(){
         PT_UB_SUVDEFICITEntity newEnt = new PT_UB_SUVDEFICITEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_UB_SUVDEFICITHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_UB_SUVDEFICITHelper.toXML(this);
  }
