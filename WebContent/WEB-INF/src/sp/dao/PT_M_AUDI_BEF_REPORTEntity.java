...
public class PT_M_AUDI_BEF_REPORTEntity extends ValueObject{
...
//생성자를 만든다
    public PT_M_AUDI_BEF_REPORTEntity(){
    }
    
    
    public PT_M_AUDI_BEF_REPORTEntity(String SEQ,String TMP_WRT_NUM,String WRT_NUM ){
       this.setSEQ(SEQ);
    ...
    public PT_M_AUDI_BEF_REPORTEntity(ValueObject ent) throws Exception{
       Object value = null; 
    ...
    public void setRequestOnlyString(HttpServletRequest request) throws Exception{
		...
		this.NOTE_NAME =request.getParameter("NOTE_NAME");
    ...
    public void setDsOnlyString(Dataset ds, int arg_row) throws Exception{  
		...
		this.NOTE_NAME =KJFMi.dsGet(ds, arg_row, "NOTE_NAME");
...
//Setter 함수를 만든다
  ...
  public String toString(){
      ...
      strB.append("NOTE_NAME:"+ this.getNOTE_NAME()+"\n");
  ...
  public String getPrefix(){
    return PT_M_AUDI_BEF_REPORTHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_M_AUDI_BEF_REPORTHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_M_AUDI_BEF_REPORTHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_M_AUDI_BEF_REPORTHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_M_AUDI_BEF_REPORTHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_M_AUDI_BEF_REPORTEntity();
  }

  public ValueObject getClone(){
         PT_M_AUDI_BEF_REPORTEntity newEnt = new PT_M_AUDI_BEF_REPORTEntity();
          ...
          newEnt.setNOTE_NAME(this.getNOTE_NAME());
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_M_AUDI_BEF_REPORTHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public void   setByName(String key, Object value){
	 ...
	 if(idx !=null)
	    switch(idx.intValue()){
             ...
             case 12 :
                    this.setNOTE_NAME((String)value);
	            return;  
  ...
  public String toXML(){
         return PT_M_AUDI_BEF_REPORTHelper.toXML(this);
  }
