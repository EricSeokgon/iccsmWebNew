...
public class PT_R_WORK_CAPABILITY_TEMPEntity extends ValueObject{
     ...
     private String SEQ_LINK_CAPABILITY;
  

//생성자를 만든다
    public PT_R_WORK_CAPABILITY_TEMPEntity(){
    }
    
    
    public PT_R_WORK_CAPABILITY_TEMPEntity(String RECV_NUM,String SEQ,String TMP_WRT_NUM ){
    ...
    public PT_R_WORK_CAPABILITY_TEMPEntity(ValueObject ent) throws Exception{
       Object value = null; 
    ...
    public void setRequestOnlyString(HttpServletRequest request) throws Exception{
		...
		this.CAP_PROC =request.getParameter("CAP_PROC");
		...
		this.SEQ_LINK_CAPABILITY =request.getParameter("SEQ_LINK_CAPABILITY");
    ...
    public void setDsOnlyString(Dataset ds, int arg_row) throws Exception{  
		...
		this.CAP_PROC =KJFMi.dsGet(ds, arg_row, "CAP_PROC");
		...
		this.SEQ_LINK_CAPABILITY =KJFMi.dsGet(ds, arg_row, "SEQ_LINK_CAPABILITY");
...
//Getter 함수를 만든다
     ...
     public String getSEQ_LINK_CAPABILITY(){
             return SEQ_LINK_CAPABILITY;
     };
...
//Setter 함수를 만든다
     ...
     public void setCAP_PROC(String CAP_PROC){
            this.CAP_PROC=CAP_PROC;
     };
     ...
     public void setSEQ_LINK_CAPABILITY(String SEQ_LINK_CAPABILITY){
            this.SEQ_LINK_CAPABILITY=SEQ_LINK_CAPABILITY;
     };
  ...
  public String toString(){
      ...
      strB.append("CAP_PROC:"+ this.getCAP_PROC()+"\n");
      ...
      strB.append("SEQ_LINK_CAPABILITY:"+ this.getSEQ_LINK_CAPABILITY()+"\n");
  ...
  public String getPrefix(){
    return PT_R_WORK_CAPABILITY_TEMPHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_R_WORK_CAPABILITY_TEMPHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_R_WORK_CAPABILITY_TEMPHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_R_WORK_CAPABILITY_TEMPHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_R_WORK_CAPABILITY_TEMPHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_R_WORK_CAPABILITY_TEMPEntity();
  }

  public ValueObject getClone(){
         PT_R_WORK_CAPABILITY_TEMPEntity newEnt = new PT_R_WORK_CAPABILITY_TEMPEntity();
          ...
          newEnt.setCAP_PROC(this.getCAP_PROC());
          ...
          newEnt.setSEQ_LINK_CAPABILITY(this.getSEQ_LINK_CAPABILITY());
         
	 return newEnt;
  }

  public Object getByName(String key){
         Integer idx = (Integer)PT_R_WORK_CAPABILITY_TEMPHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
             ...
             case 15 :
                 return  this.getSEQ_LINK_CAPABILITY();
  ...
  public void   setByName(String key, Object value){
	 ...
	 if(idx !=null)
	    switch(idx.intValue()){
             ...
             case 15 :
                    this.setSEQ_LINK_CAPABILITY((String)value);
	            return;  
  ...
  public String toXML(){
         return PT_R_WORK_CAPABILITY_TEMPHelper.toXML(this);
  }
