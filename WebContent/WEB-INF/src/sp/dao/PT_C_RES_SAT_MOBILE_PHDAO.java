...
public class PT_C_RES_SAT_MOBILE_PHDAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_SAT_MOBILE_PHEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_SAT_MOBILE_PH : insert() ");
    }
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_SAT_MOBILE_PHEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_SAT_MOBILE_PH : update() ");
    }
    PT_C_RES_SAT_MOBILE_PHEntity entity = (PT_C_RES_SAT_MOBILE_PHEntity)obj;
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_SAT_MOBILE_PHEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_SAT_MOBILE_PH : updateModifiedOnly() ");
    }
    PT_C_RES_SAT_MOBILE_PHEntity entity = (PT_C_RES_SAT_MOBILE_PHEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_C_RES_SAT_MOBILE_PHEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_C_RES_SAT_MOBILE_PH : delete() ");
    }
    PT_C_RES_SAT_MOBILE_PHEntity entity = (PT_C_RES_SAT_MOBILE_PHEntity)obj;
