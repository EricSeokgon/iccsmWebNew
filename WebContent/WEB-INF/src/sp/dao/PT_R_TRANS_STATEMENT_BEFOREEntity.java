...
public class PT_R_TRANS_STATEMENT_BEFOREEntity extends ValueObject{
...
//생성자를 만든다
    public PT_R_TRANS_STATEMENT_BEFOREEntity(){
    }
    
      
    public PT_R_TRANS_STATEMENT_BEFOREEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_R_TRANS_STATEMENT_BEFOREHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_R_TRANS_STATEMENT_BEFOREHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_R_TRANS_STATEMENT_BEFOREHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_R_TRANS_STATEMENT_BEFOREHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_R_TRANS_STATEMENT_BEFOREHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_R_TRANS_STATEMENT_BEFOREEntity();
  }

  public ValueObject getClone(){
         PT_R_TRANS_STATEMENT_BEFOREEntity newEnt = new PT_R_TRANS_STATEMENT_BEFOREEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_R_TRANS_STATEMENT_BEFOREHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_R_TRANS_STATEMENT_BEFOREHelper.toXML(this);
  }
