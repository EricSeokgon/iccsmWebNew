...
public class PT_R_REGIST_STATEMENTHelper{
  ...
  public static HashMap fieldMap = new HashMap(62);
  static{
  ...
  fieldMap.put(NAME,new Integer(8) );
  fieldMap.put(MANA_NUM,new Integer(9) );
  fieldMap.put(COM_NUM,new Integer(10) );
  fieldMap.put(REP_NM_KOR,new Integer(11) );
  fieldMap.put(REP_NM_HAN,new Integer(12) );
  fieldMap.put(ADDR_POST_NUM,new Integer(13) );
  fieldMap.put(ADDR_DETAIL_ADDR,new Integer(14) );
  fieldMap.put(ADDR_TEL_NUM,new Integer(15) );
  fieldMap.put(ADDR_FAX_NUM,new Integer(16) );
  fieldMap.put(DEFI_STE,new Integer(17) );
  fieldMap.put(WRT_ID,new Integer(18) );
  fieldMap.put(UPD_DT,new Integer(19) );
  fieldMap.put(INS_DT,new Integer(20) );
  fieldMap.put(ADDR_ADDR,new Integer(21) );
  fieldMap.put(PROC_TIME,new Integer(22) );
  fieldMap.put(REP_MOBILE,new Integer(23) );
  fieldMap.put(REP_MOBILE2,new Integer(24) );
  fieldMap.put(REP_MOBILE3,new Integer(25) );
  fieldMap.put(ADDR_TEL_NUM2,new Integer(26) );
  fieldMap.put(ADDR_TEL_NUM3,new Integer(27) );
  fieldMap.put(ADDR_FAX_NUM2,new Integer(28) );
  fieldMap.put(ADDR_FAX_NUM3,new Integer(29) );
  fieldMap.put(ADDR_TEL_NUM1,new Integer(30) );
  fieldMap.put(ADDR_FAX_NUM1,new Integer(31) );
  fieldMap.put(REP_MOBILE1,new Integer(32) );
  fieldMap.put(REP_SSN1,new Integer(33) );
  fieldMap.put(REP_SSN2,new Integer(34) );
  fieldMap.put(GUBUN,new Integer(35) );
  fieldMap.put(COI_WRT_NUM,new Integer(36) );
  fieldMap.put(MOT_STE,new Integer(37) );
  fieldMap.put(DOC_CODE,new Integer(38) );
  fieldMap.put(COMMANA_CLASS,new Integer(39) );
  fieldMap.put(OFFICE_AREA,new Integer(40) );
  fieldMap.put(DIAG_ORG_CODE,new Integer(41) );
  fieldMap.put(DIAG_NM_NM,new Integer(42) );
  fieldMap.put(COMPANY_DIAG_BAS_DT,new Integer(43) );
  fieldMap.put(PAY_CAP,new Integer(44) );
  fieldMap.put(DIAG_NM_WRT_NUM,new Integer(45) );
  fieldMap.put(COMPANY_DIAG_ISSUE_DT,new Integer(46) );
  fieldMap.put(REA_CAP,new Integer(47) );
  fieldMap.put(TUP_CLASS_CODE,new Integer(48) );
  fieldMap.put(TUP_AOM,new Integer(49) );
  fieldMap.put(OFFICE_USE_NAME,new Integer(50) );
  fieldMap.put(OFFICE_OWN_CLASS,new Integer(51) );
  fieldMap.put(LICTAX,new Integer(52) );
  fieldMap.put(HOSCRE,new Integer(53) );
  fieldMap.put(MEMO_CONT,new Integer(54) );
  fieldMap.put(TMP_WRT_NUM,new Integer(55) );
  fieldMap.put(WRT_DT,new Integer(56) );
  fieldMap.put(BUSS_YMD,new Integer(57) );
  fieldMap.put(FOREIGN_YN,new Integer(58) );
  fieldMap.put(REGIST_YMD,new Integer(59) );
  fieldMap.put(STA_CHG_CLASS_CODE,new Integer(60) );
  fieldMap.put(CHG_DT,new Integer(61) );
  fieldMap.put(EXT_CHG_CLASS_CODE,new Integer(62) );
  
  }

     final public static String PACKAGE = "sp.dao";
     final public static String TABLE = "PT_R_REGIST_STATEMENT";
     final public static String PREFIX = "sp.dao.PT_R_REGIST_STATEMENT";
   ...
   public static String toXML(PT_R_REGIST_STATEMENTEntity ent){
