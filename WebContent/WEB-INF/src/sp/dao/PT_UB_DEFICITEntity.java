...
public class PT_UB_DEFICITEntity extends ValueObject{
...
//생성자를 만든다
    public PT_UB_DEFICITEntity(){
    }
    
    
    public PT_UB_DEFICITEntity(String DEFI_SEQ,String RECV_NUM,String SIDO_CODE,String SIGUNGU_CODE ){
    ...
    public PT_UB_DEFICITEntity(ValueObject ent) throws Exception{
       Object value = null; 
...
//Setter 함수를 만든다
  ...
  public String getPrefix(){
    return PT_UB_DEFICITHelper.PREFIX;
  }
  
  public String[] getPrimaryKeyList(){
       return PT_UB_DEFICITHelper.PRIMARYKEY_LIST;
      }
  public String[] getFieldList(){
       return PT_UB_DEFICITHelper.FIELD_LIST;
      }
  public Set getFieldSet(){
       return PT_UB_DEFICITHelper.fieldMap.keySet();
      }
  public boolean isField(String key){
     return PT_UB_DEFICITHelper.fieldMap.containsKey(key);
  };      
  ...
  public ValueObject getTemp(){
          return new PT_UB_DEFICITEntity();
  }

  public ValueObject getClone(){
         PT_UB_DEFICITEntity newEnt = new PT_UB_DEFICITEntity();
  ...
  public Object getByName(String key){
         Integer idx = (Integer)PT_UB_DEFICITHelper.fieldMap.get(key);
	 if(idx !=null)
	    switch(idx.intValue()){
  ...
  public String toXML(){
         return PT_UB_DEFICITHelper.toXML(this);
  }
