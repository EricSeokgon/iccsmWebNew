...
public class PT_UB_CONMEMODAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_UB_CONMEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_CONMEMO : insert() ");
    }
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_UB_CONMEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_CONMEMO : update() ");
    }
    PT_UB_CONMEMOEntity entity = (PT_UB_CONMEMOEntity)obj;
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_UB_CONMEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_CONMEMO : updateModifiedOnly() ");
    }
    PT_UB_CONMEMOEntity entity = (PT_UB_CONMEMOEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_UB_CONMEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_CONMEMO : delete() ");
    }
    PT_UB_CONMEMOEntity entity = (PT_UB_CONMEMOEntity)obj;
