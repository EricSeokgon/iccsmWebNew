...
public class PT_UB_SUVMEMODAO  extends SuperToDB{
  ...
  public int insert( ValueObject  obj) throws SQLException{
    ...
    if((obj instanceof PT_UB_SUVMEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_SUVMEMO : insert() ");
    }
    PT_UB_SUVMEMOEntity entity = (PT_UB_SUVMEMOEntity)obj;
  ...
  sb.append("insert into PT_UB_SUVMEMO ")
  ...
  public int  update( ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_UB_SUVMEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_SUVMEMO : update() ");
    }
    PT_UB_SUVMEMOEntity entity = (PT_UB_SUVMEMOEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("update PT_UB_SUVMEMO  set ")
  ...
  public int updateModifiedOnly(ValueObject obj, String[] fields) throws SQLException{
    ...
    if((obj instanceof PT_UB_SUVMEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_SUVMEMO : updateModifiedOnly() ");
    }
    PT_UB_SUVMEMOEntity entity = (PT_UB_SUVMEMOEntity)obj;
  ...
  public int delete(ValueObject obj) throws SQLException{
    ...
    if((obj instanceof PT_UB_SUVMEMOEntity) == false){
        throw new  SQLException("DAO 에러(1): PT_UB_SUVMEMO : delete() ");
    }
    PT_UB_SUVMEMOEntity entity = (PT_UB_SUVMEMOEntity)obj;
    ...
    StringBuffer sb = new StringBuffer();
    sb.append("delete from PT_UB_SUVMEMO  where  1=1")
