...
*               REP_NM_KOR:VARCHAR2(50):  
*               REP_NM_HAN:VARCHAR2(50):  
*               REP_TEL_NUM:VARCHAR2(17):  
*               ADDR_POST_NUM:VARCHAR2(20):  
*               ADDR_ADDR:VARCHAR2(120):  
*               ADDR_DETAIL_ADDR:VARCHAR2(120):  
*               ADDR_TEL_NUM:VARCHAR2(50):  
*               ADDR_FAX_NUM:VARCHAR2(50):  
...
*               SND_STE:VARCHAR2(1):  
*               COM_NUM:VARCHAR2(20):  
*               ADDR_TEL_NUM1:VARCHAR2(120):  
*               ADDR_TEL_NUM2:VARCHAR2(120):  
*               ADDR_TEL_NUM3:VARCHAR2(120):  
*               ADDR_FAX_NUM1:VARCHAR2(120):  
*               ADDR_FAX_NUM2:VARCHAR2(120):  
*               ADDR_FAX_NUM3:VARCHAR2(120):  
*               REP_MOBILE1:VARCHAR2(4):  
*               REP_MOBILE2:VARCHAR2(4):  
*               REP_MOBILE3:VARCHAR2(4):  
*               TRANS_UNION_PROC:VARCHAR2(4):  
*               TRANS_UNION_PARENT:VARCHAR2(12):  
*               GUBUN:VARCHAR2(25):  
...
*               MIDAL_YN:VARCHAR2(1):  
*               ADDR_POST_NEW:VARCHAR2(120):  
*               ADDR1_NEW:VARCHAR2(120):  
*               ADDR2_NEW:VARCHAR2(120):  
*               ADDR_POST_OLD:VARCHAR2(120):  
*               ADDR1_OLD:VARCHAR2(120):  
*               ADDR2_OLD:VARCHAR2(120):  
*               TMP_WRT_NUM:VARCHAR2(12):  
*               SIDO_CODE:VARCHAR2(4):  
*               COMMANA_CLASS:VARCHAR2(1):  
*               MANA_NUM:VARCHAR2(18):  
...
public class PT_R_COMPANY_MASTERHelper{
  ...
  final static public String TRANS_UNION_PROC = "TRANS_UNION_PROC";
  final static public String TRANS_UNION_PARENT = "TRANS_UNION_PARENT";
  ...
  final static public String UNION_INVEST_NUM = "UNION_INVEST_NUM";
  final static public String MIDAL_YN = "MIDAL_YN";
  final static public String ADDR_POST_NEW = "ADDR_POST_NEW";
  final static public String ADDR1_NEW = "ADDR1_NEW";
  final static public String ADDR2_NEW = "ADDR2_NEW";
  final static public String ADDR_POST_OLD = "ADDR_POST_OLD";
  final static public String ADDR1_OLD = "ADDR1_OLD";
  final static public String ADDR2_OLD = "ADDR2_OLD";
  

  public static HashMap fieldMap = new HashMap(125);
  static{
  ...
  fieldMap.put(TRANS_UNION_PROC,new Integer(54) );
  fieldMap.put(TRANS_UNION_PARENT,new Integer(55) );
  fieldMap.put(GUBUN,new Integer(56) );
  fieldMap.put(MEMO_CONT,new Integer(57) );
  fieldMap.put(OFFICE_USE_NAME,new Integer(58) );
  fieldMap.put(BUSS_YMD,new Integer(59) );
  fieldMap.put(FOREIGN_YN,new Integer(60) );
  fieldMap.put(REGIST_YMD,new Integer(61) );
  fieldMap.put(COMPANY_DIAG_BAS_DT2,new Integer(62) );
  fieldMap.put(RECV_NUM,new Integer(63) );
  fieldMap.put(DOC_CODE,new Integer(64) );
  fieldMap.put(UNION_INVEST_NUM,new Integer(65) );
  fieldMap.put(MIDAL_YN,new Integer(66) );
  fieldMap.put(ADDR_POST_NEW,new Integer(67) );
  fieldMap.put(ADDR1_NEW,new Integer(68) );
  fieldMap.put(ADDR2_NEW,new Integer(69) );
  fieldMap.put(ADDR_POST_OLD,new Integer(70) );
  fieldMap.put(ADDR1_OLD,new Integer(71) );
  fieldMap.put(ADDR2_OLD,new Integer(72) );
    
  }

     final public static String PACKAGE = "sp.dao";
     final public static String TABLE = "PT_R_COMPANY_MASTER";
     final public static String PREFIX = "sp.dao.PT_R_COMPANY_MASTER";
     final public static String TABLE_DESC = "";
  
     final public static String PRIMARYKEY_LIST[] = { 
       TMP_WRT_NUM };
     final public static String FIELD_LIST[] = { 
       TMP_WRT_NUM,SIDO_CODE,COMMANA_CLASS,MANA_NUM,NAME,REP_SSN1,REP_SSN2,REP_NM_KOR,REP_NM_HAN,REP_TEL_NUM,ADDR_POST_NUM,ADDR_ADDR,ADDR_DETAIL_ADDR,ADDR_TEL_NUM,ADDR_FAX_NUM,EMAIL_ADDR,OFFICE_AREA,OFFICE_USE_CODE,COMPANY_DIAG_CLASS_CODE,COMPANY_DIAG_BAS_DT,COMPANY_DIAG_ISSUE_DT,DIAG_ORG_CODE,DIAG_NM_NM,DIAG_NM_WRT_NUM,PAY_CAP,REA_CAP,TUP_AOM,TUP_CLASS_CODE,C_COM_DT,C_COM_CAUSE_CODE,COM_COV_DT,WRT_ID,UPD_DT,INS_DT,WRT_DT,BAS_STA_DT,OFFICE_OWN_CLASS,COI_WRT_NUM,REP_MOBILE,LICTAX,HOSCRE,SND_DT,SND_STE,COM_NUM,ADDR_TEL_NUM1,ADDR_TEL_NUM2,ADDR_TEL_NUM3,ADDR_FAX_NUM1,ADDR_FAX_NUM2,ADDR_FAX_NUM3,REP_MOBILE1,REP_MOBILE2,REP_MOBILE3,TRANS_UNION_PROC,TRANS_UNION_PARENT,GUBUN,MEMO_CONT,OFFICE_USE_NAME,BUSS_YMD,FOREIGN_YN,REGIST_YMD,COMPANY_DIAG_BAS_DT2,RECV_NUM,DOC_CODE,UNION_INVEST_NUM,MIDAL_YN,ADDR_POST_NEW,ADDR1_NEW,ADDR2_NEW,ADDR_POST_OLD,ADDR1_OLD,ADDR2_OLD };
   ...
   public static String toXML(PT_R_COMPANY_MASTEREntity ent){
         ...
         xml.append("<field type='").append("String").append("' ")
            .append(" name='").append("TRANS_UNION_PROC").append("'")
            .append(" value='").append(""+ent.getTRANS_UNION_PROC()).append("' />\n");
        
         xml.append("<field type='").append("String").append("' ")
            .append(" name='").append("TRANS_UNION_PARENT").append("'")
            .append(" value='").append(""+ent.getTRANS_UNION_PARENT()).append("' />\n");
         ...
         xml.append("<field type='").append("String").append("' ")
            .append(" name='").append("UNION_INVEST_NUM").append("'")
            .append(" value='").append(""+ent.getUNION_INVEST_NUM()).append("' />\n");
         ...
         xml.append("<field type='").append("String").append("' ")
            .append(" name='").append("ADDR_POST_NEW").append("'")
            .append(" value='").append(""+ent.getADDR_POST_NEW()).append("' />\n");
        
         xml.append("<field type='").append("String").append("' ")
            .append(" name='").append("ADDR1_NEW").append("'")
            .append(" value='").append(""+ent.getADDR1_NEW()).append("' />\n");
        
         xml.append("<field type='").append("String").append("' ")
            .append(" name='").append("ADDR2_NEW").append("'")
            .append(" value='").append(""+ent.getADDR2_NEW()).append("' />\n");
        
         xml.append("<field type='").append("String").append("' ")
            .append(" name='").append("ADDR_POST_OLD").append("'")
            .append(" value='").append(""+ent.getADDR_POST_OLD()).append("' />\n");
        
         xml.append("<field type='").append("String").append("' ")
            .append(" name='").append("ADDR1_OLD").append("'")
            .append(" value='").append(""+ent.getADDR1_OLD()).append("' />\n");
        
         xml.append("<field type='").append("String").append("' ")
            .append(" name='").append("ADDR2_OLD").append("'")
            .append(" value='").append(""+ent.getADDR2_OLD()).append("' />\n");
