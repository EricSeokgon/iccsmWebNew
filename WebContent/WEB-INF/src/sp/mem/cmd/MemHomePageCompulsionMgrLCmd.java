...
public class MemHomePageCompulsionMgrLCmd implements KJFCommand {
    
    private String next;
    
    public MemHomePageCompulsionMgrLCmd() {
    }
    
    public MemHomePageCompulsionMgrLCmd(String next_url) {
        next = next_url; 
    }
    ...
    private void loadList(HttpServletRequest request, MemParam pm) throws Exception{
        ...
        String orderSQL = " ORDER BY INS_DT DESC    \n";
