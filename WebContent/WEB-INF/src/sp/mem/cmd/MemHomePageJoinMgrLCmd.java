...
public class MemHomePageJoinMgrLCmd implements KJFCommand {
	
	private String next;
	
	public MemHomePageJoinMgrLCmd() {
    }
	
	public MemHomePageJoinMgrLCmd(String next_url) {
    	next = next_url; 
    }
    ...
    private void loadList(HttpServletRequest request, MemParam pm) throws Exception{
        ...
        selectSQL.append("        PT_U.PT_SIDO_CODE.SIGUNGU_NM,  \n");        
