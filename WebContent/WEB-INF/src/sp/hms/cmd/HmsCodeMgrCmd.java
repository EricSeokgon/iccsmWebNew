...
/***************************************************************************
 * <p>Title       : HmsCodeMgrCmd Class</p>
 * <p>Description : HTML 코드관리 처리 클래스</p>
 * <p>Copyright   : Copyright(c) 2007 PKT. All rights reserved.</p>
 * 
 * NOTE : HTML 코드관리 처리를 한다. 
 * 
 * @version 1.0
 * @author  PKT
 **************************************************************************/
public class HmsCodeMgrCmd implements KJFCommand {
    
    private String next;
    
    public HmsCodeMgrCmd() {
        
    }
    
    public HmsCodeMgrCmd(String next_url) {
        next = next_url;
    }
