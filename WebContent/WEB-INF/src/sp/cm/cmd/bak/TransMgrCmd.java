...
//
		sQuery.append( " SELECT '0' AS CHECKER, RECV_NUM, RECV_DT, ASSI_NAME, ASSI_TMP_WRT_NUM, TRAN_NAME, TRAN_REP, TRAN_TMP_WRT_NUM,");
		sQuery.append( " (SELECT CODE_NAME FROM PT_COM_CODE WHERE P_CODE = 'REGPROC' AND CODE = MOT_STE) MOT_STE, CHG_DT FROM PT_R_ASSI_TRANS_STATEMENT");
