...
public class TransMgrCCUDCmd implements KJFCommand {
    ...
    public TransMgrCCUDCmd() {
    }

    public TransMgrCCUDCmd(String next_url) {
    	next = next_url;
    }
...
//    		if (ds != null) dsProc(ds);
    	...
    	else if (scMODE.equalsIgnoreCase("RECV_NUM_CHECK_SV")) // 접수번호 저장
    	{
    		ds = pReq.getDatasetList().getDataset("dsPT_R_ASSI_TRANS_STATEMENT");
    		if(ds != null) dsProc(ds);
    	}	  // ~~ END 
