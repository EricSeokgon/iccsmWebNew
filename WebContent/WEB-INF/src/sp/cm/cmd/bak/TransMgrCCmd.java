...
public class TransMgrCCmd<PT_R_DOC_NUM> implements KJFCommand {
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {
        ...
        {
        	sQuery.append(" SELECT TMP_WRT_NUM, SIDO_CODE, COMMANA_CLASS, MANA_NUM, ");
        	...
        	sQuery.append(" ADDR_FAX_NUM2, ADDR_FAX_NUM3, REP_MOBILE1, REP_MOBILE2, REP_MOBILE3 ");
        ...
        else if((sworkMODE.equalsIgnoreCase("Engineer_List"))) //양도양수 접수관리-공사업체 조회
        {
        	...
        	rMasterEntity    = rDAO.select("SELECT ENGINEER_NM, ENGINEER_SSN1, ENGINEER_SSN2,  EMPL_YMD, RET_YMD, REMARK, WRT_ID, UPD_DT, INS_DT, SEQ, TMP_WRT_NUM, TMP_FIELD,  CARE_BOOK_VAL_START_DT, CARE_BOOK_VAL_END_DT, ISSUE_DT, CARE_BOOK_ISSUE_NUM,  ENGINEER_NM AS NM_KOR, ENGINEER_SSN1 || ENGINEER_SSN2 AS SSN, TMP_FIELD AS TMP_GRADE FROM PT_R_ENGINEER_CHANGE WHERE TMP_WRT_NUM IN ('" + TR_TMP_WRT_NUM + "',"+ AS_TMP_WRT_NUM +"')");	        	        
...
/*        else if (sworkMODE.equalsIgnoreCase("RECV_NUM"))
        {
...
//        	sQuery.append(" ON PT_A.ASSI_TMP_WRT_NUM = PT_R.TMP_WRT_NUM ");
	        ...
	        sQuery.append(" ,REP_MOBILE, LICTAX, HOSCRE, COM_NUM ");
	        ...
	        sWhere.append(" AND SIDO_CODE = '" + scSIDO_CODE + "'");
	       	...
	       	KJFMi.ReEnt2Ds(dl,rMasterEntity,"output15");
	       	sQuery.delete(0, sQuery.length());
	       	sWhere.delete(0, sWhere.length());
