...
public class StdMgrCCUDCmd implements KJFCommand {
...
//    private PT_R_COM_NAME_CHANGEEntity PT_R_COM_NAME_CHANGEEnt = new PT_R_COM_NAME_CHANGEEntity();
    ...
    public StdMgrCCUDCmd() {
    }

    public StdMgrCCUDCmd(String next_url) {
    	next = next_url;
    }
...
//        	PT_R_COM_NAME_CHANGEdao.insert(PT_R_COM_NAME_CHANGEEnt);
    	...
    	{	
    		...
    		PT_R_ENGINEER_CHANGE_TEMPEnt.setSEQ(
    				getMaxChangeEngSeq(ds.getColumnAsString(arg_row, "TMP_WRT_NUM"), "PT_R_ENGINEER_CHANGE_TEMP", "SEQ"));
