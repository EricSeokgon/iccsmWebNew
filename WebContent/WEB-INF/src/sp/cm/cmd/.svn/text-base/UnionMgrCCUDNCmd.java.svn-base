...
public class UnionMgrCCUDNCmd implements KJFCommand {
    ...
    public UnionMgrCCUDNCmd() {
    }

    public UnionMgrCCUDNCmd(String next_url) {
    	next = next_url;
    }
    		...
    		*/
	    		...
	    		if (ds != null) {
		    		...
		    		if (ds != null){
		    		   	...
		    		   	String deleteQuery = " DELETE FROM PT_R_SUBSIDIARY WHERE TMP_WRT_NUM = '" + scTMP_WRT_NUM + "'";    		
