...
public class FineResultStMgrCmd implements KJFCommand {
	
    private String next;	
    private static DatasetList  dl = new DatasetList();
    private VariableList vl = new VariableList();
    
    public FineResultStMgrCmd() {
    }

    public FineResultStMgrCmd(String next_url) {
    	next = next_url;
    }
	...
	public String execute( HttpServletRequest request, ActionForm form ) throws Exception {
		...
		String selectSQL	=
							...
							" SELECT  \n" +
							" PM.COI_WRT_NUM, PM.DISPO_DT,PM.DISPO_CAUSE, PM.REMARK,PM.BUSISUSP_START_DT,PM.BUSISUSP_END_DT,PG.PAY_NOTI_DT,PG.PAY_TERM,PG.PAY_DT,PG.FINE,PM.VIOL_DT,  \n" +
						    " PC.ADDR_ADDR || PC.ADDR_DETAIL_ADDR||'('||PC.NAME||')' AS ADDR, \n" +
		...
		String fromSQL		= " FROM PT_M_MASTER PM, PT_R_COMPANY_MASTER PC, PT_M_MGR PG  \n";
		String whereSQL		= " WHERE 1 = 1  \n";
		whereSQL += "      AND PM.COI_WRT_NUM = PC.COI_WRT_NUM \n";
		whereSQL += "      AND PM.COI_WRT_NUM = PG.COI_WRT_NUM \n";
		whereSQL += "      AND PM.DISPO_CONT = 'M00003' \n"; 
