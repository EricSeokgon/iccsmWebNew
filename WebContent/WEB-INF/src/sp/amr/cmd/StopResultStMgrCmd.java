...
public class StopResultStMgrCmd implements KJFCommand {
	
    private String next;	
    private static DatasetList  dl = new DatasetList();
    private VariableList vl = new VariableList();
    
    public StopResultStMgrCmd() {
    }

    public StopResultStMgrCmd(String next_url) {
    	next = next_url;
    }
	...
	public String execute( HttpServletRequest request, ActionForm form ) throws Exception {
		...
		whereSQL += "      AND (DISPO_CONT = 'M00002' OR DISPO_CONT = 'M00009'  \n";
		whereSQL += "      OR DISPO_CONT = 'M00010' OR DISPO_CONT = 'M00011'   \n";
		whereSQL += "      OR DISPO_CONT = 'M00012' OR DISPO_CONT = 'M00013'   \n"; 
		whereSQL += "      OR DISPO_CONT = 'M00014' OR DISPO_CONT = 'M00015'   \n"; 
		whereSQL += "      OR DISPO_CONT = 'M00016' OR DISPO_CONT = 'M00017'   \n"; 
		whereSQL += "      OR DISPO_CONT = 'M00018' OR DISPO_CONT = 'M00019') \n"; 
      ...
      //시도
		...
		if( !KJFUtil.isEmpty( scBUSISUSP_START_DT  ) && !KJFUtil.isEmpty( scBUSISUSP_END_DT ) ) {
			whereSQL += "	   AND PM.BUSISUSP_START_DT BETWEEN '" + scBUSISUSP_START_DT+ "' AND '" + scBUSISUSP_END_DT + "'  \n";
		}
		if (!KJFUtil.isEmpty(scCOI_WRT_NUM))
			whereSQL +=" AND PM.COI_WRT_NUM = '" + scCOI_WRT_NUM + "' \n";
		
		//처분내용
		if( !KJFUtil.isEmpty( scDISPO_CONT ) && !"ALL".equals(scDISPO_CONT)) {
			whereSQL += " AND PM.DISPO_CONT LIKE '" + scDISPO_CONT  + "'  \n";
		}
