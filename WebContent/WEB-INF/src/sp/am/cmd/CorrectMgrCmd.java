...
public class CorrectMgrCmd implements KJFCommand {
	 
		private String next;	
	    private DatasetList  dl = new DatasetList();
	    private VariableList vl = new VariableList();
	    
	    public CorrectMgrCmd() {
	    }

	    public CorrectMgrCmd(String next_url) {
	    	next = next_url;
	    }
	    ...
	    public String execute(HttpServletRequest request, ActionForm form) throws Exception {
	        ...
	        sQuery.append(" PT_S.CORRECT_ORDER_CONT, PT_S.CORRECT_ORDER_START_DT, PT_S.CORRECT_ORDER_END_DT, ");
	        ...
	        sQuery.append(" LEFT JOIN PT_M_CORRECT PT_S ON PT_M.WRT_NUM = PT_S.WRT_NUM	");
	        ...
	        sWhere.append(" AND PT_M.DISPO_CONT = 'M00004' ");	// 시정명령 코드
