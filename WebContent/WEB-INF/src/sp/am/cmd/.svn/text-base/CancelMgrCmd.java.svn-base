...
public class CancelMgrCmd implements KJFCommand {
	    ...
	    public CancelMgrCmd(String next_url) {
	    	next = next_url;
	    }
	    ...
	    public String execute(HttpServletRequest request, ActionForm form) throws Exception {
	        ...
	        sQuery.append(" LEFT JOIN PT_M_REGIST_CANCEL PT_S ON PT_M.WRT_NUM = PT_S.WRT_NUM	");
	        ...
	        sWhere.append(" AND PT_M.DISPO_CONT = 'M00001' ");	// 등록취소 코드
