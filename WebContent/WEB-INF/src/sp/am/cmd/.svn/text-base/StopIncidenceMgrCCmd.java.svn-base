...
public class StopIncidenceMgrCCmd implements KJFCommand {
	 
		private String next;	
	    private DatasetList  dl = new DatasetList();
	    private VariableList vl = new VariableList();
	    
	    public StopIncidenceMgrCCmd() {
	    }

	    public StopIncidenceMgrCCmd(String next_url) {
	    	next = next_url;
	    }
	    ...
	    public String execute(HttpServletRequest request, ActionForm form) throws Exception {
	        ...
	        {
	        	sQuery.append(" SELECT  *  FROM PT_M_SUSPENSION ");
	        	...
	        	sQuery.append(" SELECT  *  FROM PT_M_NEGLIGENCE ");
		    	rEntity    = rDAO.select(sQuery.toString() + sWhere.toString());    	
