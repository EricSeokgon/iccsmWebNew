...
import sp.dao.PT_M_SUSPENSIONDAO;
import sp.dao.PT_M_SUSPENSIONEntity;
...
public class StopIncidenceMgrCUDCmd implements KJFCommand {
    ...
    private PT_M_SUSPENSIONDAO PT_M_SUSPENSIONdao = new PT_M_SUSPENSIONDAO();
    private PT_M_SUSPENSIONEntity PT_M_SUSPENSIONEnt = new PT_M_SUSPENSIONEntity();
    ...
    public StopIncidenceMgrCUDCmd() {
    }


    public StopIncidenceMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	if (scworkMODE.equalsIgnoreCase("INSERT_SAVE"))
    	{
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_M_SUSPENSION");
	    	if(ds != null) dsProc(ds);
    	}
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	else if(ds.getId().equalsIgnoreCase("dsPT_M_SUSPENSION"))
    	{
    		PT_M_SUSPENSIONEnt.setDsOnlyString(ds, arg_row);// 
           	KJFLog.debug(PT_M_SUSPENSIONEnt.toString());
           	PT_M_SUSPENSIONEnt.setINS_DT(KJFDate.getCurDatetime());
           	PT_M_SUSPENSIONdao.insert(PT_M_SUSPENSIONEnt);
    	}
    ...
    private void updateExe(Dataset ds, int arg_row)throws Exception{
    	...
    	else if(ds.getId().equalsIgnoreCase("dsPT_M_SUSPENSION"))
    	{
    		PT_M_SUSPENSIONEnt.setDsOnlyString(ds, arg_row);// 
           	KJFLog.debug(PT_M_SUSPENSIONEnt.toString());
           	PT_M_SUSPENSIONEnt.setUPD_DT(KJFDate.getCurDatetime());
           	PT_M_SUSPENSIONdao.update(PT_M_SUSPENSIONEnt);
    	}
    	else if(ds.getId().equalsIgnoreCase("dsPT_M_NEGLIGENCE"))
    	{
    		PT_M_NEGLIGENCEEnt.setDsOnlyString(ds, arg_row);// 
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	else if(ds.getId().equalsIgnoreCase("SUS_DEL"))
    	{
    		sQuery.append(" DELETE FROM PT_M_MEMO ");
    		sWhere.append(" WHERE WRT_NUM = '" + sKey1 + "' ");
    		sWhere.append(" AND	TMP_WRT_NUM = '" + sKey2 + "' ");
	    	...
	    	sQuery.append(" UPDATE PT_M_MASTER SET DISPO_CONT = NULL, DISPO_CONT2 = NULL, MOT_STE = NULL, DISPO_DT = NULL ");
