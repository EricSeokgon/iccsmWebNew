...
public class WarnMgrCmd implements KJFCommand {
	    ...
	    public WarnMgrCmd(String next_url) {
	    	next = next_url;
	    }
	    ...
	    public String execute(HttpServletRequest request, ActionForm form) throws Exception {
	        ...
	        sQuery.append(" PT_S.WARN_CONT, PT_S.WARN_DT, ");
	        ...
	        sQuery.append(" LEFT JOIN PT_M_WARNING PT_S ON PT_M.WRT_NUM = PT_S.WRT_NUM	");
	        ...
	        sWhere.append(" AND 	PT_M.DISPO_CONT = 'M00006' "); // 경고조치 코드
