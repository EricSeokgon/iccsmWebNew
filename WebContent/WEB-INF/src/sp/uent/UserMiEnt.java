...
public class UserMiEnt {
	...
	public UserMiEnt(String strID) throws Exception {
		this(strID, "user");
	}

	public UserMiEnt(String strID, String type) throws Exception {
    ...
    public void setSC_CO(String sc_cd) {
        SC_CD = sc_cd;
    }
