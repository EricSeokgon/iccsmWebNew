...
public class BasCMStDCmd implements KJFCommand {
	private String next;
    ...
    public BasCMStDCmd(String next_url){
    	next = next_url;
    }
...
public String execute(HttpServletRequest request, ActionForm form) throws Exception {
    	...
    	if(sWorkMODE.equalsIgnoreCase("CODE"))
    	{
    		...
    		sWhere.append(" WHERE SUBSTR(AREA_CODE, 0, 2) = SUBSTR(AREA_CODE, 3, 2)  ");
    	...
    	{
    		sQuery.append(" SELECT TMP_WRT_NUM, COI_WRT_NUM, MANA_NUM, NAME, ADDR_ADDR ");
    		sQuery.append(" FROM PT_R_COMPANY_MASTER ");
    		sWhere.append(" WHERE 1 = 1 AND TRIM(C_COM_DT) IS NULL");
    		sWhere.append(" AND ( TRANS_UNION_PROC IS NULL OR TRANS_UNION_PROC = 'N' OR TRANS_UNION_PROC = 'null')" );
