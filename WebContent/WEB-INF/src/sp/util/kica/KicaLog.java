...
public class KicaLog{
     ...
     * @param message String
     */
    public static final void logSilEx( String message){
    ...
    public static final void  logFileWrite(String key , String time,  String message){
			...
			try{
				String logFile = KICA_LOG_FILE_PATH + time.substring(0,6)+".log"; 
    ...
    public static final void  logFileWriteSilEx(String key , String time,  String message){
			...
			PrintWriter logWriter= null;
			try{
				String logFile = KICA_LOG_FILE_PATH + time.substring(0,6)+"SilEx"+".log"; 
