...
public class Crypto {
	...
	public Crypto(boolean bPrintLog) {
		...
		try {
			...
			plainText = Disk.read("C:/work/JSP_Project/iccsm/WEB-INF/src/sp/gpkisample/Sample/CRYPTO/plainText.txt");
	...
	public void AsymmetricKey() {
		...
		try {
			...
			X509Certificate cert = Disk.readCert("C:/work/JSP_Project/iccsm/WEB-INF/src/sp/gpkisample/Sample/CRYPTO/rsaCert.der");
			priKey = Disk.readPriKey("C:/work/JSP_Project/iccsm/WEB-INF/src/sp/gpkisample/Sample/CRYPTO/rsaPri.key", "1111");
			...
			cert = Disk.readCert("C:/work/JSP_Project/iccsm/WEB-INF/src/sp/gpkisample/Sample/CRYPTO/kcdsaCert.der");
			priKey = Disk.readPriKey("C:/work/JSP_Project/iccsm/WEB-INF/src/sp/gpkisample/Sample/CRYPTO/kcdsaPri.key", "1111");
