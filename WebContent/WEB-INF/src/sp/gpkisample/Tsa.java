...
public class Tsa {
	...
	public void reqTimeStamp() {
		...
		try {
			...
			message = Disk.read("C:/work/JSP_Project/iccsm/WEB-INF/src/sp/gpkisample/Sample/TSA/Message.txt");
			...
			Disk.write("C:/work/JSP_Project/iccsm/WEB-INF/src/sp/gpkisample/Sample/TSA/Message.tst", timeStampToken.getTimeStampToken());
			...
			byte[] resMsg = Disk.read("C:/work/JSP_Project/iccsm/WEB-INF/src/sp/gpkisample/Sample/TSA/TimeStampRes_nok.ber");
