...
import sp.dao.PT_C_RES_CAR_MOBILE_SYDAO;
import sp.dao.PT_C_RES_CAR_MOBILE_SYEntity;
...
public class RegCarMobileMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_CAR_MOBILE_SYDAO    dao = new PT_C_RES_CAR_MOBILE_SYDAO();
    private PT_C_RES_CAR_MOBILE_SYEntity Eent = new PT_C_RES_CAR_MOBILE_SYEntity();
   
    private VariableList vl = new VariableList();
    
    public RegCarMobileMgrCUDCmd() {
    }


    public RegCarMobileMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_CAR_MOBILE_SY");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_CAR_MOBILE_SY"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_CAR_MOBILE_SY");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_CAR_MOBILE_SY"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_CAR_MOBILE_SY  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
