...
import sp.dao.PT_C_RES_TRAFFIC_ADMINDAO;
import sp.dao.PT_C_RES_TRAFFIC_ADMINEntity;
...
public class RegTrafficadminMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_TRAFFIC_ADMINDAO    dao = new PT_C_RES_TRAFFIC_ADMINDAO();
    private PT_C_RES_TRAFFIC_ADMINEntity Eent = new PT_C_RES_TRAFFIC_ADMINEntity();
   
    private VariableList vl = new VariableList();
    
    public RegTrafficadminMgrCUDCmd() {
    }


    public RegTrafficadminMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_TRAFFIC_ADMIN");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_TRAFFIC_ADMIN"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_TRAFFIC_ADMIN");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_TRAFFIC_ADMIN"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_TRAFFIC_ADMIN  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
