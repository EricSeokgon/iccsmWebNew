...
public class RegNormalLineMgrCmd implements KJFCommand{
	
	private String next;	
    private DatasetList  dl = new DatasetList();
    private VariableList vl = new VariableList();
     
    public RegNormalLineMgrCmd() {
    }

    public RegNormalLineMgrCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {
        ...
        sQuery.append("  SELECT '0' AS CHECKER ,TO_NUMBER(NOR_TEL+DID+DOD_INSIDE+DOD_SINGLE) AS TOTAL_CNT,NL.*    \n");
        sQuery.append(" 	  FROM PT_C_RES_NORMAL_LINE NL    \n");
