...
public class RegMobilePhoneMgrCmd implements KJFCommand{
	
	private String next;	
    private DatasetList  dl = new DatasetList();
    private VariableList vl = new VariableList();
     
    public RegMobilePhoneMgrCmd() {
    }

    public RegMobilePhoneMgrCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {
        ...
        sQuery.append(" SELECT '0' AS CHECKER ,SKT_QTT+KTF_QTT+LGT_QTT+QTT_010 AS SUM_QTT ,   \n  ");
        sQuery.append("        SKT_AOM+KTF_AOM+LGT_AOM+AOM_010 AS SUM_AOM , MP.* ");
        sQuery.append(" FROM PT_C_RES_MOBILE_PHONE MP");
