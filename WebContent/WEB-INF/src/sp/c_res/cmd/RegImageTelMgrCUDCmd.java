...
import sp.dao.PT_C_RES_IMAGE_TELDAO;
import sp.dao.PT_C_RES_IMAGE_TELEntity;
...
public class RegImageTelMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_IMAGE_TELDAO    dao = new PT_C_RES_IMAGE_TELDAO();
    private PT_C_RES_IMAGE_TELEntity Eent = new PT_C_RES_IMAGE_TELEntity();
   
    private VariableList vl = new VariableList();
    
    public RegImageTelMgrCUDCmd() {
    }


    public RegImageTelMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_IMAGE_TEL");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_IMAGE_TEL"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_IMAGE_TEL");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_IMAGE_TEL"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_IMAGE_TEL  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
