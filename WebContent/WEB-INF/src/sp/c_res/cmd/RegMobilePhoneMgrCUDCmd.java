...
import sp.dao.PT_C_RES_MOBILE_PHONEDAO;
import sp.dao.PT_C_RES_MOBILE_PHONEEntity;
...
public class RegMobilePhoneMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_MOBILE_PHONEDAO    dao = new PT_C_RES_MOBILE_PHONEDAO();
    private PT_C_RES_MOBILE_PHONEEntity Eent = new PT_C_RES_MOBILE_PHONEEntity();
   
    private VariableList vl = new VariableList();
    
    public RegMobilePhoneMgrCUDCmd() {
    }


    public RegMobilePhoneMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_MOBILE_PHONE");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_MOBILE_PHONE"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_MOBILE_PHONE");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_MOBILE_PHONE"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_MOBILE_PHONE  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
