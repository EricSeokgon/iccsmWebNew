...
import sp.dao.PT_C_RES_NORMAL_LINEDAO;
import sp.dao.PT_C_RES_NORMAL_LINEEntity;
...
public class RegNormalLineMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_NORMAL_LINEDAO    dao = new PT_C_RES_NORMAL_LINEDAO();
    private PT_C_RES_NORMAL_LINEEntity Eent = new PT_C_RES_NORMAL_LINEEntity();
   
    private VariableList vl = new VariableList();
    
    public RegNormalLineMgrCUDCmd() {
    }


    public RegNormalLineMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_NORMAL_LINE");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_NORMAL_LINE"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_NORMAL_LINE");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_NORMAL_LINE"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_NORMAL_LINE  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
