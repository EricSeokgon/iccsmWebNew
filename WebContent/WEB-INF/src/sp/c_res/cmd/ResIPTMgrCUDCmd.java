...
import sp.dao.PT_C_RES_IPTDAO;
import sp.dao.PT_C_RES_IPTEntity;
...
public class ResIPTMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_IPTDAO    dao = new PT_C_RES_IPTDAO();
    private PT_C_RES_IPTEntity Eent = new PT_C_RES_IPTEntity();
   
    private VariableList vl = new VariableList();
    
    public ResIPTMgrCUDCmd() {
    }


    public ResIPTMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_IPT");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_IPT"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_IPT");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_IPT"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_IPT  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
