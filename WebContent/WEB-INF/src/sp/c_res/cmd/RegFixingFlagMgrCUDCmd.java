...
import sp.dao.PT_C_RES_FIXING_FLAGDAO;
import sp.dao.PT_C_RES_FIXING_FLAGEntity;
...
public class RegFixingFlagMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_FIXING_FLAGDAO    dao = new PT_C_RES_FIXING_FLAGDAO();
    private PT_C_RES_FIXING_FLAGEntity Eent = new PT_C_RES_FIXING_FLAGEntity();
   
    private VariableList vl = new VariableList();
    
    public RegFixingFlagMgrCUDCmd() {
    }


    public RegFixingFlagMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_FIXING_FLAG");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_FIXING_FLAG"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_FIXING_FLAG");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_FIXING_FLAG"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_FIXING_FLAG  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
