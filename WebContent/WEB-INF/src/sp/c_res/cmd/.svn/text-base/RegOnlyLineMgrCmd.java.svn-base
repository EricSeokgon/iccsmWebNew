...
public class RegOnlyLineMgrCmd implements KJFCommand{
	
	private String next;	
    private DatasetList  dl = new DatasetList();
    private VariableList vl = new VariableList();
     
    public RegOnlyLineMgrCmd() {
    }

    public RegOnlyLineMgrCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {
        ...
        sQuery.append(" SELECT '0' AS CHECKER ,OL.* ");
        sQuery.append(" FROM PT_C_RES_ONLY_LINE OL");
