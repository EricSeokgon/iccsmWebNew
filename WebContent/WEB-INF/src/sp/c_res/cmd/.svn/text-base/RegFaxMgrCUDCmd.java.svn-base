...
import sp.dao.PT_C_RES_FACSIMILEDAO;
import sp.dao.PT_C_RES_FACSIMILEEntity;
...
public class RegFaxMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_FACSIMILEDAO    dao = new PT_C_RES_FACSIMILEDAO();
    private PT_C_RES_FACSIMILEEntity Eent = new PT_C_RES_FACSIMILEEntity();
   
    private VariableList vl = new VariableList();
    
    public RegFaxMgrCUDCmd() {
    }


    public RegFaxMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_FACSIMILE");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_FACSIMILE"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_FACSIMILE");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_FACSIMILE"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_FACSIMILE  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
