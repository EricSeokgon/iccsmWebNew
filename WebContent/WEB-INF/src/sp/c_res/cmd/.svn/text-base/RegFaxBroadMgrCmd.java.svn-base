...
public class RegFaxBroadMgrCmd implements KJFCommand{
	
	private String next;	
    private DatasetList  dl = new DatasetList();
    private VariableList vl = new VariableList();
     
    public RegFaxBroadMgrCmd() {
    }

    public RegFaxBroadMgrCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {
        ...
        sQuery.append(" SELECT '0' AS CHECKER ,FB.* ");
        sQuery.append(" FROM PT_C_RES_FACSIMILE_BR FB");
