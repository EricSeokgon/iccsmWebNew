...
public class RegSatellMobileMgrCmd implements KJFCommand{
	
	private String next;	
    private DatasetList  dl = new DatasetList();
    private VariableList vl = new VariableList();
     
    public RegSatellMobileMgrCmd() {
    }

    public RegSatellMobileMgrCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {
        ...
        sQuery.append(" SELECT '0' AS CHECKER ,MP.* ");
        sQuery.append(" FROM PT_C_RES_SAT_MOBILE_PH MP");
