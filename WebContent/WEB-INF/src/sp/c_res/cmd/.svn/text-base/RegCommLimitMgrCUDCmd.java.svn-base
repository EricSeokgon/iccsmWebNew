...
import sp.dao.PT_C_RES_COMM_LIMITDAO;
import sp.dao.PT_C_RES_COMM_LIMITEntity;
...
public class RegCommLimitMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_COMM_LIMITDAO    dao = new PT_C_RES_COMM_LIMITDAO();
    private PT_C_RES_COMM_LIMITEntity Eent = new PT_C_RES_COMM_LIMITEntity();
   
    private VariableList vl = new VariableList();
    
    public RegCommLimitMgrCUDCmd() {
    }


    public RegCommLimitMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_COMM_LIMIT");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_COMM_LIMIT"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_COMM_LIMIT");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_COMM_LIMIT"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_COMM_LIMIT  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
