...
public class RegFaxMgrCmd implements KJFCommand{
    ...
    public RegFaxMgrCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {
        ...
        sQuery.append(" SELECT '0' AS CHECKER ,RF.* ");
        sQuery.append(" FROM PT_C_RES_FACSIMILE RF");
