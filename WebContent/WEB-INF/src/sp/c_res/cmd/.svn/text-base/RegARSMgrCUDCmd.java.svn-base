...
import sp.dao.PT_C_RES_ARSDAO;
import sp.dao.PT_C_RES_ARSEntity;
...
public class RegARSMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_ARSDAO    dao = new PT_C_RES_ARSDAO();
    private PT_C_RES_ARSEntity Eent = new PT_C_RES_ARSEntity();
   
    private VariableList vl = new VariableList();
    
    public RegARSMgrCUDCmd() {
    }


    public RegARSMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_ARS");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_ARS"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_ARS");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_ARS"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_ARS  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
