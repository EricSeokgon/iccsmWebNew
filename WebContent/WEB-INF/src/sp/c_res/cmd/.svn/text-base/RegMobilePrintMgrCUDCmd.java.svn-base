...
import sp.dao.PT_C_RES_SANDDAO;
import sp.dao.PT_C_RES_SANDEntity;
...
public class RegMobilePrintMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_SANDDAO    dao = new PT_C_RES_SANDDAO();
    private PT_C_RES_SANDEntity Eent = new PT_C_RES_SANDEntity();
   
    private VariableList vl = new VariableList();
    
    public RegMobilePrintMgrCUDCmd() {
    }


    public RegMobilePrintMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_SAND");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_SAND"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_SAND");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_SAND"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_SAND  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
