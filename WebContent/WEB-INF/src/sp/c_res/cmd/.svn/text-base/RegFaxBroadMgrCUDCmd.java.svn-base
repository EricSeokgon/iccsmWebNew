...
import sp.dao.PT_C_RES_FACSIMILE_BRDAO;
import sp.dao.PT_C_RES_FACSIMILE_BREntity;
...
public class RegFaxBroadMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_FACSIMILE_BRDAO    dao = new PT_C_RES_FACSIMILE_BRDAO();
    private PT_C_RES_FACSIMILE_BREntity Eent = new PT_C_RES_FACSIMILE_BREntity();
   
    private VariableList vl = new VariableList();
    
    public RegFaxBroadMgrCUDCmd() {
    }


    public RegFaxBroadMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_FACSIMILE_BR");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_FACSIMILE_BR"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_FACSIMILE_BR");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_FACSIMILE_BR"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_FACSIMILE_BR  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
