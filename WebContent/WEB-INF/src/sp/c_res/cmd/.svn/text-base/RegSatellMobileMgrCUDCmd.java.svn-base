...
import sp.dao.PT_C_RES_SAT_MOBILE_PHDAO;
import sp.dao.PT_C_RES_SAT_MOBILE_PHEntity;
...
public class RegSatellMobileMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_SAT_MOBILE_PHDAO    dao = new PT_C_RES_SAT_MOBILE_PHDAO();
    private PT_C_RES_SAT_MOBILE_PHEntity Eent = new PT_C_RES_SAT_MOBILE_PHEntity();
   
    private VariableList vl = new VariableList();
    
    public RegSatellMobileMgrCUDCmd() {
    }


    public RegSatellMobileMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_SAT_MOBILE_PH");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_SAT_MOBILE_PH"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_SAT_MOBILE_PH");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_SAT_MOBILE_PH"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_SAT_MOBILE_PH  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
