...
import sp.dao.PT_C_RES_TRAFFIC_OUTDAO;
import sp.dao.PT_C_RES_TRAFFIC_OUTEntity;
...
public class RegTrafficOutMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_TRAFFIC_OUTDAO    dao = new PT_C_RES_TRAFFIC_OUTDAO();
    private PT_C_RES_TRAFFIC_OUTEntity Eent = new PT_C_RES_TRAFFIC_OUTEntity();
   
    private VariableList vl = new VariableList();
    
    public RegTrafficOutMgrCUDCmd() {
    }


    public RegTrafficOutMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_TRAFFIC_OUT");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_TRAFFIC_OUT"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_TRAFFIC_OUT");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_TRAFFIC_OUT"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_TRAFFIC_OUT  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
