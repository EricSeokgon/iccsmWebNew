...
import sp.dao.PT_C_RES_PRIVATEDAO;
import sp.dao.PT_C_RES_PRIVATEEntity;
...
public class ResNetworkPrivateMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_PRIVATEDAO    dao = new PT_C_RES_PRIVATEDAO();
    private PT_C_RES_PRIVATEEntity Eent = new PT_C_RES_PRIVATEEntity();
   
    private VariableList vl = new VariableList();
    
    public ResNetworkPrivateMgrCUDCmd() {
    }


    public ResNetworkPrivateMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_PRIVATE");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_PRIVATE"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_PRIVATE");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_PRIVATE"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_PRIVATE  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
