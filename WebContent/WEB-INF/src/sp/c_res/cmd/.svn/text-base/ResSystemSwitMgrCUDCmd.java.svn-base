...
import sp.dao.PT_C_RES_SWITDAO;
import sp.dao.PT_C_RES_SWITEntity;
...
public class ResSystemSwitMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_SWITDAO    dao = new PT_C_RES_SWITDAO();
    private PT_C_RES_SWITEntity Eent = new PT_C_RES_SWITEntity();
   
    private VariableList vl = new VariableList();
    
    public ResSystemSwitMgrCUDCmd() {
    }


    public ResSystemSwitMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_SWIT");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_SWIT"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_SWIT");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_SWIT"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_SWIT  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
