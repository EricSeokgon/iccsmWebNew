...
import sp.dao.PT_C_RES_IMAGE_SYSTEMDAO;
import sp.dao.PT_C_RES_IMAGE_SYSTEMEntity;
...
public class RegImageSysMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_IMAGE_SYSTEMDAO    dao = new PT_C_RES_IMAGE_SYSTEMDAO();
    private PT_C_RES_IMAGE_SYSTEMEntity Eent = new PT_C_RES_IMAGE_SYSTEMEntity();
   
    private VariableList vl = new VariableList();
    
    public RegImageSysMgrCUDCmd() {
    }


    public RegImageSysMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_IMAGE_SYSTEM");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_IMAGE_SYSTEM"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_IMAGE_SYSTEM");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_IMAGE_SYSTEM"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_IMAGE_SYSTEM  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
