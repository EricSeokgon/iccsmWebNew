...
public class RegCarMobileMgrCmd implements KJFCommand{
	
	private String next;	
    private DatasetList  dl = new DatasetList();
    private VariableList vl = new VariableList();
     
    public RegCarMobileMgrCmd() {
    }

    public RegCarMobileMgrCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {
        ...
        sQuery.append(" SELECT '0' AS CHECKER ,MS.* ");
        sQuery.append(" FROM PT_C_RES_CAR_MOBILE_SY MS");
