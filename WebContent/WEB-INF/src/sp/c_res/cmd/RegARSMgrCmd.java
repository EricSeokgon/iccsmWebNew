...
public class RegARSMgrCmd implements KJFCommand{
    ...
    public RegARSMgrCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {
        ...
        sQuery.append(" SELECT '0' AS CHECKER ,RA.* ");
        sQuery.append(" FROM PT_C_RES_ARS RA");
