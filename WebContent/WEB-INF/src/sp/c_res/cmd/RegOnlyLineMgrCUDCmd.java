...
import sp.dao.PT_C_RES_ONLY_LINEDAO;
import sp.dao.PT_C_RES_ONLY_LINEEntity;
...
public class RegOnlyLineMgrCUDCmd implements KJFCommand {
	
    private String next;
    
    private PT_C_RES_ONLY_LINEDAO    dao = new PT_C_RES_ONLY_LINEDAO();
    private PT_C_RES_ONLY_LINEEntity Eent = new PT_C_RES_ONLY_LINEEntity();
   
    private VariableList vl = new VariableList();
    
    public RegOnlyLineMgrCUDCmd() {
    }


    public RegOnlyLineMgrCUDCmd(String next_url) {
    	next = next_url;
    }
    ...
    public String execute(HttpServletRequest request, ActionForm form) throws Exception {   	    	
    	...
    	Dataset dsde ;
	    	...
	    	ds = pReq.getDatasetList().getDataset("dsPT_C_RES_ONLY_LINE");
    ...
    private void insertExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_ONLY_LINE"))
    	{
    		...
    		String SEQ = KJFDBUtil.getMaxID("SEQ","PT_C_RES_ONLY_LINE");
    ...
    private void deleteExe(Dataset ds, int arg_row)throws Exception{
    	...
    	if(ds.getId().equalsIgnoreCase("dsPT_C_RES_ONLY_LINE"))
    	{
			...
			deleteQuery.append(" DELETE FROM PT_C_RES_ONLY_LINE  WHERE SIDO_CODE = '"+SIDO_CODE+"' AND SEQ = '"+SEQ+"' ");
