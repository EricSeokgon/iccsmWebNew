...
<%
	...
	/* 기본 설정 */
		for (int i = 0 ; i < irow ; i++)
		{
		  ...
		  filename = inds.getColumn(i, "sys_file_name").toString();		
			ByteArrayInputStream is = new ByteArrayInputStream(file);
			
			//String filePath = Config.props.get("AREA_FILE_DIR")+"usebefore/"+sido_code+"/"+sigg_code;
		...
		//	System.out.println("##"+filePath);
			...
			if (result >= 1){
				KJFFile.deleteFile(filePath2, filename); // dir에서 파일을 삭제한다.
			}
