...
<html>
	...
	<OBJECT id = "ozrviewer" CLASSID="CLSID:0DEF32F8-170F-46f8-B1FF-4BF7443F5F25" width="100%" height="100%">
		...
		<PARAM NAME="connection.reportname" value="/BeforeInvest/BeforeConsResultR.ozr">
		<PARAM NAME="odi.odinames" value="Q)BeforeConsResultR,Q)BfCertTable"> 
		<% 
		...
		<% } %>
		<PARAM NAME="odi.Q)BeforeConsResultR.pcount" value="3">
		<PARAM NAME="odi.Q)BeforeConsResultR.args1" value="RECV_NUM=<%=request.getParameter("scRECV_NUM")%>">
		<PARAM NAME="odi.Q)BeforeConsResultR.args2" value="SIDO_CODE=<%=request.getParameter("SIDO_CODE")%>">
		<PARAM NAME="odi.Q)BeforeConsResultR.args3" value="SIGUNGU_CODE=<%=request.getParameter("SIGUNGU_CODE")%>">
